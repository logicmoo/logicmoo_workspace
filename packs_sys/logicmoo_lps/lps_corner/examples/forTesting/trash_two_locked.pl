...
initially trash(bottle1).

bin(container1).
bin(container2).
initially  locked(container1), locked(container2).
observe  unlock(container1) from 4 to 5.
observe  unlock(container2) from 2 to 3.



if trash(Object) at T1 then  bin(Container) at T1, 
