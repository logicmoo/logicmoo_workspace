...
% saves and terminates the program. To resume it later:
% golps('examples/forTesting/saver.pl',[dc,restore('life_saved_state.pl')]).  But use full file paths.
...
/* Uncomment this to get an experimental 2d display; then you might comment out again the display(live... and display(die... clauses:
