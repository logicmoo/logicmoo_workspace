...
% JENKINS: https://jenkins.logicmoo.org/job/logicmoo_workspace/lastBuild/testReport/logicmoo.base.examples.fol/FOL_BIRDT_01/logicmoo_base_examples_fol_FOL_BIRDT_01_JUnit/ 
