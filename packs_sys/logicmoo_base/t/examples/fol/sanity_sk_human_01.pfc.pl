...
% JENKINS: https://jenkins.logicmoo.org/job/logicmoo_workspace/lastBuild/testReport/logicmoo.base.examples.fol/SANITY_SK_HUMAN_01/logicmoo_base_examples_fol_SANITY_SK_HUMAN_01_JUnit/ 
