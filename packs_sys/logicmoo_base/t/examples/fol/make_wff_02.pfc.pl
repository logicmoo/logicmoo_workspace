...
% JENKINS: https://jenkins.logicmoo.org/job/logicmoo_workspace/lastBuild/testReport/logicmoo.base.examples.fol/MAKE_WFF_02/logicmoo_base_examples_fol_MAKE_WFF_02_JUnit/ 
