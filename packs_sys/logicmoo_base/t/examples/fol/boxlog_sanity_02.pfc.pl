...
% JENKINS: https://jenkins.logicmoo.org/job/logicmoo_workspace/lastBuild/testReport/logicmoo.base.examples.fol/BOXLOG_SANITY_02/logicmoo_base_examples_fol_BOXLOG_SANITY_02_JUnit/ 
