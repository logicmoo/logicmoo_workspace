...
% JENKINS: https://jenkins.logicmoo.org/job/logicmoo_workspace/lastBuild/testReport/logicmoo.base.examples.fol/POSS_FORALL_EXISTS_03/logicmoo_base_examples_fol_POSS_FORALL_EXISTS_03_JUnit/ 
