...
:- add_test(t121a, (exactly(1,[[Heart,tHeart]],all([[Human,tAnimal]],hasOrgan(Human,Heart))))).

:- add_test(t122,  
  (all(Human,  
    isa(Human,tAnimal) 
      => exactly(1,Heart,(isa(Heart,tHeart) & hasOrgan(Human,Heart)))))).
...
% ISSUE: https://github.com/logicmoo/logicmoo_workspace/issues/437 
% EDIT: https://github.com/logicmoo/logicmoo_workspace/edit/master/packs_sys/logicmoo_base/t/examples/fol/sanity_exactly_01.pfc.pl 
% JENKINS: https://jenkins.logicmoo.org/job/logicmoo_workspace/lastBuild/testReport/logicmoo.base.examples.fol/SANITY_EXACTLY_01/logicmoo_base_examples_fol_SANITY_EXACTLY_01_JUnit/ 
% ISSUE_SEARCH: https://github.com/logicmoo/logicmoo_workspace/issues?q=is%3Aissue+label%3ASANITY_EXACTLY_01 
