/*  patched_rdf_parser.pl,v 1.2 2007-09-01 13:55:13 ch Exp
    ...
    - Mon Apr 15 11:39:09 2002, Christoph Wernhard
      - Import references changed to library(uri) and library(rewrite)
        (to allow this file living in another directory than these).
      - Modified propertyElt such that empty property elements gives empty
        literals
