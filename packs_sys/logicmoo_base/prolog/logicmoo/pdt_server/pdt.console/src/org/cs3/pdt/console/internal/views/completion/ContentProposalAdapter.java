...
//		}
	 ...
	 */
	private KeyStroke[] triggerKeyStrokes;
	...
	public ContentProposalAdapter(Control control,
			...
			IContentProposalProvider proposalProvider, KeyStroke[] keyStrokes,
		...
		this.triggerKeyStrokes = keyStrokes;
...
//				} else
	...
	private boolean allowsAutoActivate() {
		return (autoActivateString != null && autoActivateString.length() > 0) // there are specific autoactivation chars supplied
		  || (autoActivateString == null && triggerKeyStrokes == null);    // we autoactivate on everything
	}
