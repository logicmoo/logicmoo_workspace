...
public class AnalysisTableNameColumnLabelProvider extends ColumnLabelProvider {
	...
	public String getText(Object element) {
		if (element instanceof IAnalysisCategory) {
			return ((IAnalysisCategory) element).getName();
		} else if (element instanceof IAnalysis) {
			return ((IAnalysis) element).getName();
		}
	...
	public String getToolTipText(Object element) {
		if (element instanceof IAnalysis) {
			return "Type: " + ((IAnalysis) element).getSeverity();
		}
