...
%%%% 
%%%% Set PIE environment variable to the toyelim directory of your
%%%% installation
%%%%
...
% :- ensure_loaded('/Users/ch/provers/scratch/scratch_views_lit').
...
% 	  %%%%
% 	  default_external_sat_solver = minisat2(0),
...
% 	  %%%%
% 	  external_solvers =
% 	     [ minisat2(0) - '/opt/local/bin/minisat -verb=1',
% 	       minisat2(1) - '/opt/local/bin/minisat -verb=2',
% 	       minisat2(2) - '/opt/local/bin/minisat-core -verb=2',
