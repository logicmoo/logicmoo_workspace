;;; libmpdel-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "libmpdel" '("libmpdel-"))
...
(register-definition-prefixes "libmpdel-directory" '("libmpdel-directory--"))
