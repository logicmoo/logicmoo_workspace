...
%TODO uncomment this ! sanity_check(When,Must):- show_call(must_or_rtrace(When)),!,must_or_rtrace(Must),!.
sanity_check(When,Must):- show_call(must_or_rtrace(When)),!,must_or_rtrace(ignore(Must)),!.
