...
Test[
    Daniel`ARC`ARCInferObjectImage[
        <|
            "Shapes" -> {<|"Name" -> "Y", "Angle" -> 0, "StemHeight" -> 3|>},
            "Color" -> 2,
            "Width" -> 5,
            "Height" -> 6
        |>,
    ...
    ,
    TestID -> "ARCInferObjectImage-20221111-IK424D"
]

Test[
    Daniel`ARC`ARCInferObjectImage[
        <|
            "Shapes" -> {<|"Name" -> "Y", "Angle" -> 90, "StemHeight" -> 3|>},
            "Color" -> 2,
            "Width" -> 5,
            "Height" -> 6
        |>,
    ...
    ,
    TestID -> "ARCInferObjectImage-20221111-K027C9"
]