...
Test[
    Daniel`ARC`ARCSimplifyRules[
        Daniel`ARC`ARCFindRules[Daniel`ARC`ARCParseFile[file = "b7249182"]["Train"]]
    ]
    ,
    <|
        "RotationNormalization" -> <|"ObjectsAngle" -> 90|>,
                    ...
                    "Rules" -> {
                        <|"Y.Rank" -> 2|> -> <|
                            "Shape" -> <|
                                "Name" -> "Y",
                                "Angle" -> 180,
                                "StemHeight" -> Inactive[Plus][
                                    Inactive[Times][
                                        Daniel`ARC`ObjectValue["Parent", "Height"],
                                        0.5
                                    ],
                                    -2
                                ]
                            |>,
                            "X" -> Inactive[Plus][
                                Daniel`ARC`ObjectValue["InputObject", "X"],
                                -2
                            ],
                            "Width" -> 5,
                            "Y" -> Daniel`ARC`ObjectValue["InputObject", "Y"],
                            "Height" -> Inactive[Times][
                                Daniel`ARC`ObjectValue["Parent", "Height"],
                                1/2
                            ]
                        |>,
                        <|"Y.Rank" -> 1|> -> <|
                            ...
                            "Width" -> 5,
                            "Y2" -> Daniel`ARC`ObjectValue["InputObject", "Y2"],
                            "Height" -> Inactive[Times][
                                Daniel`ARC`ObjectValue["Parent", "Height"],
                                1/2
                            ]
