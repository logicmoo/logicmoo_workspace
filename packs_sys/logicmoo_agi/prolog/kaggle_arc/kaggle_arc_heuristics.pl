...
individualizers_from_pair(PairName,In,Out,IH,IV,OH,OV,ShapesI,ShapesO):-
  individuals_from_intruder_pair(PairName,In,Out,IH,IV,OH,OV,ShapesI,ShapesO).

tie_break_individualizer(PairName,ImO,OmI,IMass,OMass,ShapesIO,ShapesIO):-
  grid_size(ImO,IH,IV), grid_size(OmI,OH,OV),
  show_pair_no_i(IH,IV,OH,OV,tie_break,PairName,ImO,OmI),  
...
grid_color_individualizer(PairName,In,Out,IH,IV,OH,OV,
    ...
    _ICsL,IPCsL,CommonCsL,OPCsL,_OCsL, I,O):- % fail,
    ...
    show_pair_no_i(IH,IV,OH,OV,grid_color_individualizer,PairName,ImO,OmI),
...
grid_color_individualizer0(PairName,In,Out,IH,IV,OH,OV,
  ...
  grid_to_individual(ImO,NoiseObject), do_action(add_shape_lib(pair,NoiseObject)),
...
grid_color_individualizer0(PairName,In,Out,IH,IV,OH,OV,
  ...
  individuate([],ShapesI,ImO,NewImO), 
