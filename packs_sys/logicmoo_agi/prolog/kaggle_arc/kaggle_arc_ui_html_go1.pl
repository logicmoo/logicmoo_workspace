...
<div id="sample">
  <div id="`,ID,`" style="border: 1px solid black; width: 90%; height: 90%; position: relative; -webkit-tap-highlight-color: rgba(255, 255, 255, 0);"><canvas tabindex="0" width="700" height="350" style="position: absolute; top: 0px; left: 0px; z-index: 2; user-select: none; touch-action: none; width: 700px; height: 350px;">This text is displayed if your browser does not support the Canvas HTML element.</canvas><div style="position: absolute; overflow: auto; width: 700px; height: 350px; z-index: 1;"><div style="position: absolute; width: 1px; height: 1px;"></div></div></div>
  <p>
...
{"from":1,"to":1009,"category":"Mapping"},
{"from":14,"to":1010,"category":"Mapping"},
{"from":15,"to":1015,"category":"Mapping"},
{"from":16,"to":1015,"category":"Mapping"},
{"from":0,"to":1},
{"from":0,"to":2},
{"from":2,"to":3},
{"from":0,"to":4},
