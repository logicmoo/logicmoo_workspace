(DEFINE (PROBLEM LOG01)
   ...
   (:OBJECTS PACKAGE1 PACKAGE2 PACKAGE3 AIRPLANE1 AIRPLANE2 PGH BOS
             LA PGH-TRUCK BOS-TRUCK LA-TRUCK PGH-PO BOS-PO LA-PO
             PGH-CENTRAL BOS-CENTRAL LA-CENTRAL PGH-AIRPORT BOS-AIRPORT
             LA-AIRPORT)
   (:INIT (OBJ PACKAGE1)
          (OBJ PACKAGE2)
          (OBJ PACKAGE3)
