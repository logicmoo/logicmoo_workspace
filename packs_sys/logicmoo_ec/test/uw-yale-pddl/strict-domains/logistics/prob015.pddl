(DEFINE (PROBLEM LOG06)
   ...
   (:OBJECTS PACKAGE1 PACKAGE2 PACKAGE3 PACKAGE4 PACKAGE5 PACKAGE6
             PACKAGE7 PACKAGE8 PACKAGE9 AIRPLANE1 AIRPLANE2 PGH BOS LA NY SF
             PGH-TRUCK BOS-TRUCK LA-TRUCK NY-TRUCK SF-TRUCK PGH-PO BOS-PO
             LA-PO NY-PO SF-PO PGH-CENTRAL BOS-CENTRAL LA-CENTRAL
             NY-CENTRAL SF-CENTRAL PGH-AIRPORT BOS-AIRPORT LA-AIRPORT
             NY-AIRPORT SF-AIRPORT)
   (:INIT (OBJ PACKAGE1)
          (OBJ PACKAGE2)
          (OBJ PACKAGE3)
          (OBJ PACKAGE4)
