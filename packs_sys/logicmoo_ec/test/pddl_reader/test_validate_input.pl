...
test:-
	cd('ipc2008-no-cybersec/seq-opt/elevators-strips/'),
	write('Testing problem set elevators'), nl,
	test_colection,
	cd('../../../'),
	cd('ipc2008-no-cybersec/seq-opt/openstacks-strips/'),
	write('Testing problem set openstacks'), nl,
	test_colection,
	cd('../../../'),
	cd('ipc2008-no-cybersec/seq-opt/parcprinter-strips/'),
	write('Testing problem set parcprinter'), nl,
	test_colection,
	cd('../../../'),
	cd('ipc2008-no-cybersec/seq-opt/pegsol-strips/'),
	write('Testing problem set pegsol'), nl,
	test_colection,
	cd('../../../'),
	cd('ipc2008-no-cybersec/seq-opt/scanalyzer-strips/'),
	write('Testing problem set scanalyzer'), nl,
	test_colection,
	cd('../../../'),
	cd('ipc2008-no-cybersec/seq-opt/sokoban-strips/'),
	write('Testing problem set sokoban'), nl,
	test_colection,
	cd('../../../'),
	cd('ipc2008-no-cybersec/seq-opt/transport-strips/'),
	write('Testing problem set transport'), nl,
	test_colection,
	cd('../../../'),
	cd('ipc2008-no-cybersec/seq-opt/woodworking-strips/'),
