...
:- call_pel_directive(translate(begining,
                                '/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/ReaderTest.lps.pl')).
% Sun, 21 Mar 2021 23:28:13 GMT File: <stream>(0x555567866d00)% [physobj1,physobj2]
...
:-was_s_l('/mnt/sdc1/logicmoo_workspace.1/packs_sys/logicmoo_ec/ext/ec_sources/ecnet/ReaderTest.e',1).
if(initially(on(Physobj1, Physobj2)),  (equals(Physobj1, pen1), equals(Physobj2, desk1);equals(Physobj1, paper1), equals(Physobj2, desk1))).
...
%              Time)))).
 %   [Time].
if(thereExists(Page,bookIsOpenTo1(Book,Page)),
   not(bookClosed(Book))).
