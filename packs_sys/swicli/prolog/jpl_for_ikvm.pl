...
jFindClass(ClassName, Class) :- current_predicate(user:cliFindClass/2),user:cliFindClass(ClassName, Class),!.
jFindClass(ClassName, Class) :-
...
add_jpl_to_classpath :-
	...
	concat_atom([Old,JplJAR], Separator, New),
...
% jpl_c_lib_version("4.0.30319.42000").
