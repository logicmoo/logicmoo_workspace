...
-- concrete sharedSpecificPro of sharedSpecific = sharedGeneralPro, numbersEng, orderNumEng, swedishDBPro ** {

-- ENGLISH VERSION, UNCOMMENT AS NEEDED
--# -path=.:../:../DBase/English:../DBase:../Shared:../System:../Numbers
concrete sharedSpecificPro of sharedSpecific = sharedGeneralPro, numbersEng, orderNumEng, englishDBPro ** {
