...
public class InOutTextScore extends JFrame implements ActionListener{
	...
	liboaa.oaaRegisterCallback("oaa_AppDoEvent",
        ...
        IclList slvs = new IclList();
	slvs.add(IclTerm.fromString(true,"tkit_call_module(input,init)"));
	//"tkit_call_module(input,input),"+
	slvs.add(IclTerm.fromString(true,"tkit_call_module(input,quit)"));
	slvs.add(IclTerm.fromString(true,"tkit_call_module(output,init)"));
	slvs.add(IclTerm.fromString(true,"tkit_call_module(output,output)"));
	slvs.add(IclTerm.fromString(true,"tkit_call_module(output,quit)"));
