...
input_form(['diagnosis'],ask(X^disease(X))).
...
input_form([tests],ask(confirmed_by_tests)).
...
synset([[flu],[influenzalike,illness],[flu-like,illness],[influenza,like,illness],[flu,like,illness]],'influenzalike illness').
