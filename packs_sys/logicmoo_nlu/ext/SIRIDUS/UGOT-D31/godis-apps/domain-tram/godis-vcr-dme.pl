/*************************************************************************
         ...
         name: godis-vcr-text
      version: 
  description: GoDiS VCR application specification file, text, windows
...
selected_modules([ %input/init :  input_textscore,
                   %input/quit :  input_textscore,
                   %output/init : output_simpletext,
                   %output/quit : output_simpletext,
		   interpret/init : interpret_simple,
		   interpret/quit : interpret_simple, 
                   generate/init : generate_simple,
                   generate/quit : generate_simple,
                   %input : input_textscore,
		   %input:input_gui_basic_oaa,
