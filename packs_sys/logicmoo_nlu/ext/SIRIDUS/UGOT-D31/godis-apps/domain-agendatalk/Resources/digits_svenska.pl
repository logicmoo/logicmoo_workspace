...
dayStr([nittonde],19).
dayStr([tionde],20).
dayStr([tjugoförsta],21).
dayStr([tjugoandra],22).
dayStr([tjugotredje],23).
dayStr([tjugofjärde],24).
dayStr([tjugofemte],25).
dayStr([tjugosjätte],26).
dayStr([tjugosjunde],27).
dayStr([tjugoåttonde],28).
dayStr([tjugonionde],29).
dayStr([trettionde],30).
dayStr([trettioförsta],31).
...
monthStr( [juli],7).
monthStr( [augusti] , 8).
monthStr( [september] ,9).
monthStr( [oktober] , 10).
monthStr( [november] ,11).
monthStr( [december] , 12).
