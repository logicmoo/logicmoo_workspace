...
number_phrase([one,hundred], 100).
number_phrase([one,hundred,and,one], 101).
number_phrase([one,hundred,and,two], 102).
number_phrase([one,hundred,and,three], 103).
number_phrase([one,hundred,and,four], 104).
number_phrase([one,hundred,and,five], 105).
number_phrase([one,hundred,and,six], 106).
number_phrase([one,hundred,and,seven], 107).
number_phrase([one,hundred,and,eight], 108).
number_phrase([one,hundred,and,nine], 109).
