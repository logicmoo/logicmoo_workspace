...
number_phrase([hundratio], 110).
number_phrase([hundraelva], 111).
number_phrase([hundratolv], 112).
number_phrase([hundratretton], 113).
number_phrase([hundrafjorton], 114).
number_phrase([hundrafemton], 115).
number_phrase([hundrasexton], 116).
number_phrase([hundrasjutton], 117).
number_phrase([hundraarton], 118).
number_phrase([hundranitton], 119).
number_phrase([hundratjugo], 120).
number_phrase([hundratrettio], 130).
number_phrase([hundrafyrtio], 140).
number_phrase([hundrafemtio], 150).
number_phrase([hundrasextio], 160).
number_phrase([hundrasjuttio], 170).
number_phrase([hundraåttio], 180).
number_phrase([hundranittio], 190).

number_phrase([tvåhundra], 200).
number_phrase([tvåhundratio], 110).
number_phrase([tvåhundratjugo], 220).
number_phrase([tvåhundratrettio], 230).
number_phrase([tvåhundrafyrtio], 240).
number_phrase([tvåhundrafemtio], 250).
number_phrase([tvåhundrasextio], 260).
number_phrase([tvåhundrasjuttio], 270).
number_phrase([tvåhundraåttio], 280).
number_phrase([tvåhundranittio], 290).
number_phrase([trehundra], 300).
number_phrase([trehundratio], 310).
number_phrase([trehundratjugo], 320).
number_phrase([trehundratrettio], 330).
number_phrase([trehundrafyrtio], 340).
number_phrase([trehundrafemtio], 350).
number_phrase([trehundrasextio], 360).
