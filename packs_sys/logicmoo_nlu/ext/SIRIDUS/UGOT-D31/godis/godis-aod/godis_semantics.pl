...
* [SL 050631] Added a definition of "resolves" for alternative-questions, which only requires that the predicate of the answer matches some predicate in the list of alternatives.
...
% Alt-question, "right predicate in answer";
% SL 050630
relevant_answer( set(AltList), Alt, Domain ):-
	member( Alt1, AltList ),
	Alt1 =.. [P|_],
	Alt =.. [P|_],
	Domain:sort_restr(Alt). 
