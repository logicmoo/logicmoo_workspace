...
java -cp ${CP} -DTRINDIKIT=../trindikit4 -DGODIS=../godis -DGFAGENT=../gfc2java com.sri.oaa2.agt.startit.Startit -delay 250 -props lamps_unimodal.unix.props lamps_unimodal.config
