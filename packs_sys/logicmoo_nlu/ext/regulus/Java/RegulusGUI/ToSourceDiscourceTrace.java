...
public class ToSourceDiscourceTrace extends JFrame implements  MouseListener,VetoableChangeListener,InternalFrameListener{

	private RegulusGUI regulusWindow = null;
	private Frame3     frame3       = null;
	private JInternalFrame tosourcediscourcetrace = null;
    ...
    private String ac = "";
    private JButton tosourcediscourcebtn =     new JButton("Source Discource Trace");
    private int ToSourceDiscourceCounter = 0;
    private boolean this_is_window_button = false;
    
//  send name of internal frame 
	  public JInternalFrame getInternalFrame() {
		  return tosourcediscourcetrace;
	  }
...
public  ToSourceDiscourceTrace() {
		  
	  }

public ToSourceDiscourceTrace(Frame3 frame,CreateFrame3 createframe, RegulusGUI regulusgui,
	  ...
	  tosourcediscourcebtn = Treebtn;
	  ToSourceDiscourceCounter = treeCounter;
	  tosourcediscourcebtn.addMouseListener(this);
	  ...
	  tosourcediscourcetrace = new JInternalFrame("To Source Discource Trace",true,true,true,true);
	  setDefaultCloseOperation( JInternalFrame.DISPOSE_ON_CLOSE );
	  
	  Container c2 = tosourcediscourcetrace.getContentPane();
	  setFrame3(frame);
	  setRegulusGUI(regulusgui);
	  tosourcediscourcetrace.addInternalFrameListener(this);
...
//	 create the listmodel
	  ...
	  tosourcediscourcetrace.addVetoableChangeListener(this);
	  tosourcediscourcetrace.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
	  tosourcediscourcetrace.setLocation(0,250);
	  setSize(30,30);
	  tosourcediscourcetrace.pack();
...
public void internalFrameClosing(InternalFrameEvent e) {
    ...
    public void internalFrameDeiconified(InternalFrameEvent e) {
    	getselectedFrame();
    	tosourcediscourcebtn =     new JButton(strName);
    	regulusWindow.barPanel.add(tosourcediscourcebtn);
    	tosourcediscourcebtn.addMouseListener(this);
    	getselectedFrame();
    }
...
{
		ac = tosourcediscourcebtn.getActionCommand();
