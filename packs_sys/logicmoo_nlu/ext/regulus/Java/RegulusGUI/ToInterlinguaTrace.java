...
public class ToInterlinguaTrace extends JFrame implements  MouseListener,VetoableChangeListener,InternalFrameListener{
	
	private RegulusGUI regulusWindow = null;
	private Frame3     frame3       = null;
	private JInternalFrame tointerlinguatrace = null;
    ...
    private String ac = "";
    private JButton toInterlinguabtn =     new JButton("To interlingua Trace");
    private int toInterlinguaCounter = 0;
    private boolean this_is_window_button = false;
    
	 // send name of internal frame 
	  public JInternalFrame getInternalFrame() {
		  return tointerlinguatrace;
	  }
...
public  ToInterlinguaTrace() {
		  
	  }

public ToInterlinguaTrace(Frame3 frame,CreateFrame3 createframe, RegulusGUI regulusgui,
	  ...
	  toInterlinguabtn = Treebtn;
	  toInterlinguaCounter = treeCounter;
	  toInterlinguabtn.addMouseListener(this);
	  ...
	  tointerlinguatrace = new JInternalFrame("To Interlingua Trace",true,true,true,true);
	  setDefaultCloseOperation( JInternalFrame.DISPOSE_ON_CLOSE );
	  
	  Container c2 = tointerlinguatrace.getContentPane();
	  setFrame3(frame);
	  setRegulusGUI(regulusgui);
	  tointerlinguatrace.addInternalFrameListener(this);
...
//	 create the listmodel
	  ...
	  tointerlinguatrace.addVetoableChangeListener(this);
	  tointerlinguatrace.setDefaultCloseOperation(WindowConstants.DISPOSE_ON_CLOSE);
	  tointerlinguatrace.setLocation(0,250);
	  setSize(30,30);
	  tointerlinguatrace.pack();
}
...
public void internalFrameClosing(InternalFrameEvent e) {
    ...
    public void internalFrameDeiconified(InternalFrameEvent e) {
    	getselectedFrame();
    	toInterlinguabtn =     new JButton(strName);
    	regulusWindow.barPanel.add(toInterlinguabtn);
    	toInterlinguabtn.addMouseListener(this);
    	getselectedFrame();
    }
...
{
		ac = toInterlinguabtn.getActionCommand();
