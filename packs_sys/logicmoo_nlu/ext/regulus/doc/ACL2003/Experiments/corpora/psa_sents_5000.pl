...
sent('turn on the fan').
sent('turn on the fan').
sent('turn off crew hatch fan').
sent('turn off crew hatch fan').
sent('turn off crew hatch fan').
sent('turn off crew hatch fan').
sent('turn off fan at crew hatch').
sent(okay).
sent('turn on fan at pilots seat').
sent(okay).
sent('measure temperature').
sent('measure temperature at commanders seat').
sent(yes).
sent('measure temperature at sleep').
sent('measure temperature at sleep').
sent('measure temperature at sleep station').
sent(okay).
sent('turn off fan at pilots seat').
sent(okay).
sent('turn on fan at sleep stations').
sent(okay).
sent('measure temperature at sleep stations').
sent('open storage door').
sent('open door at storage').
sent('open storage').
sent(okay).
sent('measure temperature at storage').
sent(okay).
sent('what is the current temperature').
sent('go to flight deck').
sent(okay).
sent('move to commanders seat and measure radiation').
sent(affirmative).
...
sent(okay).
sent(okay).
sent('move to the crew hatch and measure temperature and carbon dioxide').
sent(okay).
sent('go to the access ladder').
sent('temperature and carbon dioxide at access ladder').
sent('what is the temperature and carbon dioxide at access ladder').
sent(okay).
sent('measure at storage lockers').
sent('what is it at storage lockers').
sent(okay).
sent('what \'s the temperature').
sent('what is the temperature').
sent('what is temperature and carbon dioxide at storage').
sent(okay).
sent('at lower deck').
...
sent(okay).
sent(stop).
sent('at the other two decks').
sent('at mid deck and flight deck').
sent(yeah).
sent('at the commanders seat').
sent(okay).
sent('check the access ladder').
sent(yes).
sent('move to the access ladder').
sent(okay).
sent(stop).
sent(continue).
sent('what is the temperature and carbon dioxide level').
sent('what is it at the lower and mid deck').
sent(okay).
sent(yes).
sent(yes).
sent('what \'s the temperature').
sent(okay).
sent('temperature and carbon dioxide at storage').
sent('what is the temperature and carbon dioxide at storage').
sent('check temperature and carbon dioxide at storage').
sent('what is the temperature and carbon dioxide level at storage').
sent(okay).
sent('what is it at storage lockers').
sent(okay).
sent(stop).
sent('what is it at crew hatch and storage lockers').
sent(no).
sent('what is temperature and carbon dioxide level at access ladder and storage lockers').
sent(no).
sent('what is temperature and carbon dioxide at crew hatch and storage lockers').
sent(okay).
sent('what is it at mid and lower deck').
sent(no).
sent('what is temperature and carbon dioxide level at mid deck and lower deck').
sent(okay).
sent(yes).
sent('check both at flight deck').
sent('check temperature and carbon dioxide at flight deck').
sent('what is temperature and carbon dioxide level at flight deck').
sent(okay).
sent('at pilots seat').
sent(okay).
sent('go to flight deck').
...
sent(yeah).
sent(stop).
sent('what is the carbon dioxide level at current location').
sent('what is the carbon dioxide level at current location').
sent(continue).
sent('close storage').
sent(yes).
...
sent('move to the crew hatch').
sent(yes).
sent('what \'s the temperature according to p s a').
sent('what is the temperature according to the p s a sensors').
sent('what \'s the temperature at the access ladder').
sent(okay).
sent(okay).
sent('what \'s the temperature at the storage locker').
sent('what \'s the temperature at storage').
sent('what is the temperature at storage').
sent(okay).
sent('what \'s the temperature at the storage lockers').
sent('what \'s the temperature at the storage lockers').
sent(yeah).
sent('at the access ladder').
sent(okay).
sent(yeah).
sent('check the lower deck').
sent(okay).
sent(yeah).
sent('check the other two decks').
sent('check the temperature at the other two decks').
sent('get temperature at mid deck and flight deck').
sent('what \'s the temperature at mid deck and flight deck').
sent(okay).
sent(okay).
sent('at commanders seat').
sent(yeah).
sent(yes).
sent('turn fan on').
sent(okay).
...
sent('open the door').
sent('open the crew hatch').
sent('is the temperature decreasing now').
sent('is the temperature decreasing now').
sent('is the temperature decreasing').
sent(okay).
sent('what is it').
sent('what is it at the commanders seat').
sent(yes).
sent('measure radiation at crew hatch').
sent(yeah).
sent('temperature and carbon dioxide').
sent('flight deck access ladder and storage lockers').
sent(okay).
sent(yes).
sent('what \'s the radiation').
sent(okay).
sent('turn on fans at access ladder and storage lockers').
sent('what is the radiation level').
sent(okay).
sent('turn both fans off').
sent(okay).
sent('turn off fan at access ladder').
sent(okay).
sent(yes).
sent(yes).
sent('check radiation at all three decks').
sent('radiation at all three decks').
sent('what is the radiation at all three decks').
sent(okay).
sent('close the mid deck door').
sent('close door at storage lockers').
sent('storage lockers').
sent('close the hatch at storage lockers').
sent('close storage lockers').
sent(okay).
sent(yes).
sent('what \'s the radiation at flight deck').
sent('close storage').
sent(yes).
sent('close access ladder').
sent('close crew hatch').
sent(yes).
sent('is radiation decreasing').
sent(okay).
...
sent('go to the access ladder').
sent(yes).
sent('what is the temperature here according to the p s a and the fixed sensors').
sent('according to the fixed sensors').
sent('according to the p s a').
sent('what is the c o two level here').
sent('what is the c o two level here').
...
sent(yes).
sent('according to the fixed sensor').
sent('what \'s the temperature here according to the p s a').
sent('what is the temperature here according to the p s a').
sent('according to the fixed sensors').
sent('go to the storage lockers and tell me what the temperature is').
sent('go to the storage lockers').
sent(yes).
sent('what is the temperature and carbon dioxide level here according to the fixed sensors').
sent(stop).
sent('what is the temperature and the carbon dioxide level here according to the p s a').
sent('go to the lower deck').
sent(yes).
sent('at storage').
sent(yes).
...
sent('go to the sleeping quarters').
sent('go to the mid deck').
sent(yes).
sent(stop).
...
sent(yes).
sent('and at the lower deck').
sent('the temperature at the lower deck').
sent('go to the lower deck').
sent(yes).
sent(yes).
sent(okay).
...
sent(yes).
sent('is the fan on').
sent('go to the pilots seat').
sent('go to sleep').
sent('go to sleep stations').
sent(yes).
sent('what \'s the temperature here').
sent('go to the pilots seat').
sent(yes).
sent('what is the temperature and the carbon dioxide level here').
sent('go to the commanders seat').
...
sent(yes).
sent('according to the fixed sensor').
sent('what \'s the carbon dioxide level at the crew hatch').
sent('what is the carbon dioxide level at the crew hatch').
sent('according to the fixed sensors').
sent('go to the storage lockers').
sent(yes).
sent('what \'s the carbon dioxide level here').
sent('what is the carbon dioxide level here').
sent('according to the p s a').
sent('close the storage lockers').
sent('close the storage lockers').
...
sent('turn on the fan').
sent(yes).
sent('what is the temperature here according to the fixed sensor').
sent('what is the carbon dioxide level here according to the fixed sensor and to the p s a').
sent('what is the carbon dioxide level here according to the fixed sensor and the p s a').
sent('and according to the p s a').
sent('according to the p s a').
sent('go to the storage').
sent(yes).
sent('what is the temperature and the carbon dioxide level here').
sent('measure the temperature and carbon dioxide level at the lower deck').
sent(no).
sent('go to flight deck').
sent(okay).
sent('move to commanders seat and measure radiation').
...
sent('is the carbon dioxide level decreasing at access ladder').
sent('is the carbon dioxide level decreasing at access ladder').
sent('is the carbon dioxide level decreasing at the access ladder').
sent(okay).
sent('p s a sensors').
sent(yes).
sent('what is carbon dioxide level and temperature at crew hatch').
...
sent('go to storage lockers and open them').
sent('yeah').
sent('what is the temperatu').
sent('at the crew hatch according to fixed sensors').
sent(again).
sent('is the temperature at the crew hatch increasing').
sent(okay).
sent('go to storage and measure the temperature').
sent(okay).
sent('measure the c oh two').
sent('measure the carbon dioxide').
sent('measure the temperature and carbon dioxide at the lower deck').
sent('p s a sensors').
sent(okay).
sent('measure the temperature and carbon dioxide at the crew hatch').
sent(okay).
sent(again).
sent('measure the carbon dioxide and temperature at the access ladder').
sent(okay).
sent('go to the storage lockers').
sent(okay).
sent('what is the temperature and carbon dioxide').
sent('what was the temperature at the crew hatch').
sent('when you were there').
sent('at fifteen oh five what was the temperature at the crew hatch').
...
sent('is the temperature increasing').
sent(no).
sent('is the temperature at the lower deck increasing according to fixed sensors').
sent(okay).
sent('turn on the fan').
sent(okay).
sent('turn on the fan at the storage lockers').
sent(okay).
sent('is the carbon dioxide level decreasing').
sent('is the carbon dioxide level decreasing').
sent(okay).
sent('go to the crew hatch and measure the temperature').
sent(okay).
sent('what is the carbon dioxide level').
sent('measure the temperature at crew hatch access ladder storage storage lockers and lower deck').
sent('measure the temperature at the lower deck').
sent(good).
sent('measure the temperature at the lower deck and crew hatch').
sent('go the middle deck').
sent('go to storage').
sent(stop).
sent('what is the temperature').
sent('go to storage').
...
sent('go to lower deck').
sent(okay).
sent('measure the temperature and carbon dioxide level').
sent('what is the carbon dioxide level').
sent('measure the temperature and carbon dioxide level at storage and crew hatch and lower de').
sent(okay).
sent('measure carbon dioxide and temperature at crew hatch and storage lockers').
sent(okay).
sent('measure at access ladder').
sent(okay).
sent('measure the carbon dioxide level').
...
sent(okay).
sent(okay).
sent('measure carbon dioxide at the access ladder').
sent('what is the carbon dioxide level at the crew hatch').
sent('measure carbon dioxide level at crew hatch').
sent(okay).
sent('what is the temperature at lower deck').
sent(okay).
sent('what is the temperature at lower deck').
...
sent('measure carbon dioxide level in commanders seat').
sent(stop).
sent('measure carbon dioxide level and temperature at storage lockers').
sent('measure carbon dioxide level and temperature at storage lockers').
sent(yes).
sent('do the same for all three decks').
sent(yes).
...
sent('measure the temperature').
sent('according to').
sent('according to ships sensors').
sent('what is the temperature according to fixed sensors').
sent('what is the carbon dioxide at the crew hatch').
sent('go to the access ladder').
sent(okay).
sent('what is the temperature').
sent('according to p s a sensors').
sent('turn on the fan at the access ladder').
sent(okay).
sent('what is the carbon dioxide at the access ladder').
sent('what is the temperature at the access ladder').
sent('go to storage').
sent(okay).
sent('measure the carbon dioxide and the temperature').
sent('go to the lower deck').
sent(okay).
sent('the lower deck').
sent(okay).
sent('what is the carbon dioxide and temperature').
sent('measure the carbon dioxide and temperature at the storage lockers').
sent(okay).
sent('go to the crew hatch').
sent(okay).
sent('according to fixed sensors what is the temperature at the crew hatch').
sent('what is the temperature at the crew hatch according to fixed sensors').
sent('according to p s a sensors what is the temperature at the crew hatch').
sent('what is the temperature at the crew hatch according to p s a sensors').
sent('what is the carbon dioxide at the crew hatch').
sent('go to the crew hatch').
sent(yes).
sent(stop).
sent('go to the lower deck').
sent(yes).
sent('measure the radiation carbon dioxide and temperature').
sent('measure the radiation carbon dioxide and temperature').
sent('measure the temperature').
sent('measure the carbon dioxide').
sent('measure the radiation').
...
sent('measure the radiation').
sent(again).
sent('is the radiation at the lower deck rising').
sent('is the radiation at the lower deck rising').
sent('is the radiation at the lower deck increasing').
sent(yes).
sent('is the radiation at the lower deck rising').
sent('what is the radiation at the lower deck').
sent('close the lower deck').
sent('close the lower deck').
sent('go to storage').
sent(okay).
sent(stop).
sent(stop).
sent('turn off the fan at the lower deck').
sent(yes).
sent('measure the radiation at the lower deck').
sent(yes).
sent('is the radiation at the lower deck increasing').
sent(yes).
sent('go to the storage lockers').
...
sent('measure the temperature and carbon dioxide').
sent('is the fan on').
sent('turn the fan on').
sent(okay).
sent('what is the carbon dioxide').
sent('measure the carbon dioxide and temperature at storage').
sent(stop).
sent(no).
sent('measure the temperature and carbon dioxide at the access ladder').
sent(okay).
sent('measure the radiation').
sent('close the storage lockers').
sent(okay).
sent('measure the radiation').
sent('turn off the fan at the storage lockers').
sent(okay).
sent('is the radiation level decreasing').
sent(yes).
sent('go to the access ladder').
sent(yes).
...
sent('move to commanders seat and measure radiation').
sent(affirmative).
sent('measure temperature and carbon dioxide at storage according').
sent('measure temperature and carbon dioxide at storage according to the p s a sensor').
sent('measure temperature and carbon dioxide at storage according to p s a sensor').
sent(yes).
sent('measure carbon dioxide at access ladder and lower deck').
...
sent(yes).
sent('measure temperature at crew hatch').
sent('go to storage and measure c o two and temperature').
sent(no).
sent('go to storage and measure c o two and temperature').
sent('go to storage and measure carbon dioxide and temperature').
sent(yes).
sent('what is the carbon dioxide').
sent('go to lower deck').
sent(yes).
...
sent(yes).
sent('measure carbon dioxide and temperature').
sent('go to lower deck and measure carbon dioxide').
sent(yes).
sent(yes).
sent(sure).
sent('go to access ladder').
...
sent('measure temperature at crew hatch').
sent(yes).
sent('what is the temperature at the pilots seat according to the fixed sensors').
sent('move to lower deck and measure temperature').
sent(yes).
sent('according to the fixed sensors what is the temperature in the sleep').
sent('go to commanders seat').
sent(yes).
sent('measure the temperature and the carbon dioxide').
sent('go to mid deck').
sent('go to mid deck').
sent('go to access ladder').
sent(okay).
...
sent('go to storage').
sent(yes).
sent('what is the temperature and carbon dioxide at the commanders seat according to the fixe').
sent(sensors).
sent('go to lower deck').
sent(stop).
sent('go to lower deck').
sent(yes).
sent('measure carbon dioxide and temperature').
sent('according to the fixed sensors what is the temperature and carbon dioxide in sleep').
sent('what is the carbon dioxide and temperature in sleep according to the fixed sensors').
sent('according to the fixed sensors what is the carbon dioxide and temperature in the sleep').
sent('go to sleep stations').
sent(yes).
sent('measure carbon dioxide and temperature').
sent('according to the fixed sensors what is the temperature at the pilots seat').
sent('what is the temperature at the pilots seat according to the fixed sensors').
sent('go to flight deck').
sent(yes).
sent('measure the temperature and carbon dioxide').
sent('measure the carbon dioxide and temperature').
sent('go to storage').
sent(yes).
sent('measure the carbon dioxide and temperature').
sent('measure the carbon dioxide and temperature in the sleep stations').
sent(yes).
sent('go to flight deck').
sent(yes).
sent('what is the temperature at crew hatch').
...
sent('switch it off').
sent(okay).
sent('what was the temperature at the access ladder').
sent('what was the temperature at the access ladder at fifteen oh two according to the fixed').
sent('close the crew hatch').
sent(yes).
sent('measure the temperature at crew hatch and access ladder').
...
sent('what is the carbon dioxide level here').
sent('measure the carbon dioxide level and temperature').
sent('what is the carbon dioxide level and').
sent('what is the carbon dioxide level and temperature at the storage lockers').
sent('what is the carbon dioxide level and temperature at the storage lockers').
sent(yes).
sent('do the same for all three decks').
...
sent('close storage').
sent(yes).
sent('go to storage locker').
sent('go to storage lockers').
sent(yes).
sent(stop).
sent('measure the carbon dioxide and temperature at the crew hatch').
sent(yes).
%sent('do that in the storage lockers').
sent('repeat that in the storage lockers').
sent('do the same for the storage lockers').
sent(yes).
sent('do the same').
sent('do the same for the access ladder').
sent(yes).
sent('what is the temperature at the sleep stations').
sent(yes).
sent('and the carbon dioxide').
sent('what is the carbon dioxide').
sent('go to storage').
sent(yes).
sent('measure carbon dioxide and temperature').
...
sent(yes).
sent('what is the temperature and carbon dioxide').
sent('according to the fixed sensors what is the temperature at the pilots seat and the comma').
sent(seat).
sent('according to the fixed sensors what is the temperature and carbon dioxide at the pilots').
sent('what is the temperature and the carbon dioxide at the pilots seat according to the fixe').
sent(sensors).
sent('what is the temperature and carbon dioxide').
sent('go to mid deck').
sent(yes).
sent('what is the temperature and the carbon dioxide').
sent('go to flight deck').
sent(yes).
sent('according to the fixed sensors what is the temperature and the carbon dioxide').
sent('what is the temperature and the carbon dioxide according to the p s a sensors').
sent('go to commanders seat').
sent(yes).
sent('what is the temperature and the carbon dioxide').
sent('turn on fan').
sent(yes).
sent('is the temperature stable').
sent('is the temperature stable').
sent('what is the temperature').
sent('go to storage').
sent(yes).
...
sent(all).
sent('close storage door').
sent('close door to storage').
sent('close storage door').
sent('close storage hatch').
sent('close storage').
sent(yes).
sent('measure radiation').
sent('measure radiation').
...
sent('go to storage and measure carbon dioxide and temperature').
sent(okay).
sent('go to crew hatch and measure carbon dioxide and temperature').
sent(okay).
sent('go to lower deck and measure carbon dioxide and temperature').
sent(okay).
sent('go to access ladder and measure carbon dioxide and temperature').
sent(yes).
sent('go to storage lockers and measure carbon dioxide and temperature').
sent(okay).
sent('go to pilots seat and measure carbon dioxide and temperature').
sent(okay).
sent('go to flight deck and measure carbon dioxide and temperature').
sent(okay).
sent('measure carbon dioxide and temperature at the flight deck according to fixed sensors').
sent('go to mid deck').
sent(okay).
sent('measure carbon dioxide and temperature according to fixed sensors').
sent('according to p s a sensors').
sent('stop').
sent('go to storage and mea').
sent('carbon dioxide and temperature').
sent(okay).
sent('and according to fixed sensors').
sent('measure the carbon dioxide and temperature according to fixed sensors at storage').
sent('go to lower deck and measure carbon dioxide and temperature').
sent(okay).
sent('go to access ladder and measure carbon dioxide and temperature').
sent(yes).
...
sent('go to storage lockers and measure carbon dioxide and temperature').
sent(okay).
sent('measure carbon dioxide and temperature in the sleep area').
sent('measure carbon dioxide and temperature in the sleep area').
sent('measure carbon dioxide and temperature in the sleep station').
sent('measure carbon dioxide and temperature at the commanders seat').
sent('go to mid deck and measure carbon dioxide and temperature').
sent(okay).
sent('according to the fixed sensors').
sent('what is the temperature and carbon dioxide level at the mid deck according to fixed sen').
sent('go to storage and measure carbon dioxide and temperature').
sent(okay).
sent(stop).
sent(stop).
...
sent(okay).
sent('switch it off').
sent('switch the fan off at the crew hatch').
sent(okay).
sent('what was the temperature at the access ladder at fifteen oh two').
sent('according to the fixed sensors').
sent('close the crew hatch').
sent(yes).
sent('measure the temperature at crew hatch and access ladder').
...
sent('measure the carbon dioxide and close storage').
sent(yes).
sent('go to crew hatch and measure the temperature').
sent(okay).
sent('turn the fan on at crew hatch').
sent(okay).
sent('what is the temperature at crew hatch').
sent('turn fan on at crew hatch').
sent(okay).
sent('measure the temperature at crew hatch').
sent('measure the temperature at lower deck').
sent(okay).
sent('what is the temperature at the access ladder').
sent(okay).
sent('measure temperature at all three decks').
sent(okay).
sent('measure the temperature at the pilots seat').
sent(okay).
sent('measure the temperature at commanders seat').
sent(okay).
sent('turn the fan on at commanders seat').
sent(okay).
sent(okay).
sent(okay).
sent('what is the temperature at commanders seat').
sent('measure the carbon dioxide levels at crew hatch and access ladder').
sent(okay).
sent('what is the carbon dioxide and temperature at storage lockers').
sent(okay).
sent('do the same for storage').
sent(okay).
sent('do the same at lower deck').
sent('measure carbon dioxide and temperature at lower deck').
sent(okay).
sent('measure carbon dioxide and temperature at your current location').
sent('measure radiation at the current location').
sent('measure carbon dioxide and temperature at the crew hatch').
sent(okay).
sent('and at the lower deck').
sent(okay).
sent('according to the fixed sensors').
sent('what is the radiation at the current location').
sent('measure radiation at lower deck').
sent('how much').
sent('measure radiation at lower deck').
sent('turn fan on at lower deck').
sent(okay).
sent('what is the temperature and radiation at the lower deck').
sent('according to p s a sensors').
sent('what is the radiation at mid deck').
sent(okay).
sent('what is the carbon dioxide temperature and radiation at access ladder').
sent('measure the carbon dioxide temperature and radiation at access ladder').
sent('measure the carbon dioxide and temperature at access ladder').
sent(okay).
sent(okay).
sent(radiation).
sent('measure radiation').
sent('turn fan on at crew hatch').
sent(okay).
sent('what is the radiation at present location').
sent(again).
sent('what is the carbon dioxide and temperature at storage lockers').
sent('measure carbon dioxide and temperature at storage lockers').
sent(okay).
...
sent(stop).
sent(continue).
sent('what was the temperature at the storage lockers at fifteen point oh six').
sent('what was the temperature at the storage lockers at fifteen point oh six').
sent('what was the temperature at the storage lockers at fifteen oh six').
sent('according to the fixed sensors').
sent('move to commanders seat').
...
sent('move to storage lockers').
sent(okay).
sent('measure temperature at storage lockers').
sent('move to pilots seat').
sent(okay).
sent('measure temperature at pilots seat').
sent('measure temperature at all three decks').
...
sent('measure temperature at access ladder').
sent(okay).
sent('is the carbon dioxide level increasing').
sent(okay).
sent(okay).
sent('is carbon dioxide stable at crew hatch').
sent('measure carbon dioxide at crew hatch').
sent(okay).
sent('go to storage').
sent(okay).
sent('check carbon dioxide level at storage').
sent('measure carbon dioxide level at storage').
sent('measure temperature at storage').
sent('go to storage lockers').
sent(okay).
sent('measure carbon dioxide level at storage lockers').
sent('measure temperature at storage lockers').
sent('go to lower deck').
