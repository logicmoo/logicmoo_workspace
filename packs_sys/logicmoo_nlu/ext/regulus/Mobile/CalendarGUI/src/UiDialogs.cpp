...
gboolean UiDialogs::ConfirmDialog(GtkWindow* parent, const char* text, const char* title)
{
	...
	gint					response;
	PangoFontDescription*	font = pango_font_description_from_string("Monospace Bold 18");
	GtkDialog*				dialog = BaseDialog(parent, title);
