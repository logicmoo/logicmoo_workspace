...
class RegSettings {
	...
	private String recPackage = null;

	private boolean isSLMSelected = true;
    
	private String recStringEncoding = null;
	...
	public RegSettings(String languageName, Properties pConfig) {
		...
		recPackage = pConfig.getProperty(languageName + ".recognition.package");

		recStringEncoding = pConfig.getProperty(languageName + ".recognition.characterEncoding", "iso-8859-1");
