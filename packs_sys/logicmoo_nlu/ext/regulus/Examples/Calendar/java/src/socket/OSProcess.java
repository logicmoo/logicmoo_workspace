...
//extends Thread{
    ...
    File workingDir; // working directory when executing the external command 
     ...
     * @param command to be executed as a command in a separate process 
     */
    public OSProcess(String command, String[] envVar, File wDir){
        init(command, envVar, wDir);
        
    }

       
    private void init(String command, String[] envVar, File wDir) {
    ...
    {    	
        try
        {
        	final InputStreamReader isr = new InputStreamReader(is);
                ...
                logger.warning("Problem when getting the input stream of the process runtime command." + ioe.getMessage());  
            }
