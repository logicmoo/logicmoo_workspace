...
possible_update([ynq, _Action, _Shape, _Direction, _Rotation, Pattern, _Location, _Cardinal, _Weapon], InS, AbsAct, OutS) :-
	member(Pattern, InS),
	AbsAct = say(Pattern),
	OutS = InS.
...
possible_update([imp, make, Shape, _Direction, _Rotation, _Pattern, _Location, _Cardinal, _Weapon], InS, AbsAct, OutS) :-
...
possible_update([imp, move, _Shape, Direction, _Rotation, _Pattern, _Location, _Cardinal, _Weapon], InS, AbsAct, OutS) :-
	AbsAct = say([move, Direction]),
	OutS = InS.
	
possible_update([imp, move, _Shape, _Direction, _Rotation, _Pattern, _Location, Cardinal, _Weapon], InS, AbsAct, OutS) :-
...
possible_update([imp, rotate, _Shape, Direction,_Rotation, _Pattern, _Location, _Cardinal, _Weapon], InS, AbsAct, OutS) :-
	AbsAct = say([face, Direction]),
	OutS = InS.

possible_update([imp, rotate, _Shape, _Direction, _Rotation, _Pattern, _Location, Cardinal, _Weapon], InS, AbsAct, OutS) :-
...
possible_update([imp, go, _Shape, _Direction, _Rotation, _Pattern, _Location, _Cardinal, _Weapon], InS, AbsAct, OutS) :-
	AbsAct = say([move]),
	OutS = InS.
...
possible_update([imp, stop, _Shape, _Direction, _Rotation, _Pattern, _Location, _Cardinal, _Weapon], InS, AbsAct, OutS) :-
	AbsAct = say([stop]),
	OutS = InS.
	
possible_update([imp, reset,_Shape, _Direction, _Rotation, _Pattern, _Location, _Cardinal, _Weapon], InS, AbsAct, OutS) :-
	AbsAct = say([reset]),
	OutS = InS.	
...
possible_update([imp, fire, _Shape, _Direction, _Rotation, _Pattern, _Location, _Cardinal, Weapon], InS, AbsAct, OutS) :-
