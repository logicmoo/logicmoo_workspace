...
:- use_module('$REGULUS/Examples/Toy1Specialised/Prolog/input_manager').
:- use_module('$REGULUS/Examples/Toy1Specialised/Prolog/dialogue_manager').
:- use_module('$REGULUS/Examples/Toy1Specialised/Prolog/output_manager').
