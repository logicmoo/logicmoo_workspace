...
:- use_module('$REGULUS/Examples/Toy1/Prolog/input_manager_corrections').
:- use_module('$REGULUS/Examples/Toy1/Prolog/dialogue_manager_corrections').
:- use_module('$REGULUS/Examples/Toy1/Prolog/output_manager_corrections').
...
toy1_app(Port) :-
	RecognitionPackage = '$REGULUS/Examples/Toy1/Generated/recogniser_corrections',
...
process_recogniser_output(RecogniserOutput, InState, OutState) :-
	format('~N~n              Old state:', []),
	print_dialogue_state(InState),
