...
file("Toy1Course_ETI", 'H:/Prive/Regulus/Examples/Toy1Course/scripts/toy1_course_ETI.cfg').
file("Toy1Course", '$REGULUS/Examples/Toy1Course/scripts/toy1_course.cfg').
file("Course_SLT_EngFre_ETI", 'H:/Prive/Regulus/Examples/Toy1Course/scripts/course_slt_ETI.cfg').
file("Course_SLT_EngFre", '$REGULUS/Examples/Toy1Course/scripts/course_slt.cfg').
