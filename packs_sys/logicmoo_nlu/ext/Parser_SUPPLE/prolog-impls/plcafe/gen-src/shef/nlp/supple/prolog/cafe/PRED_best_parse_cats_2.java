...
/*
 * *** Please do not edit ! ***
 * @(#) PRED_best_parse_cats_2.java
 * @procedure best_parse_cats/2 in compile_grammar.pl
 */
...
public class PRED_best_parse_cats_2 extends Predicate {
    ...
    public PRED_best_parse_cats_2(Term a1, Term a2, Predicate cont) {
        arg1 = a1; 
        arg2 = a2; 
        this.cont = cont;
    }

    public PRED_best_parse_cats_2(){}
    ...
    public String toString() {
        return "best_parse_cats(" + arg1 + ", " + arg2 + ")";
    }
}
