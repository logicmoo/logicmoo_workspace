 ...
 * *** Please do not edit ! ***
 * @(#) PRED_verbose_0.java
 * @procedure verbose/0 in plcafe_supple_io.pl
 */
...
public class PRED_verbose_0 extends Predicate {
    static SymbolTerm s1 = SymbolTerm.makeSymbol("verbose");
    static SymbolTerm f2 = SymbolTerm.makeSymbol(":", 2);
    static SymbolTerm s3 = SymbolTerm.makeSymbol("shef.nlp.supple.prolog.cafe");

    public PRED_verbose_0(Predicate cont) {
        this.cont = cont;
    }

    public PRED_verbose_0(){}
