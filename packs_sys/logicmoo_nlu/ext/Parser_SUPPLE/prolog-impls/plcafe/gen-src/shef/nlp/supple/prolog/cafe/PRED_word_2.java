 ...
 * *** Please do not edit ! ***
 * @(#) PRED_word_2.java
 * @procedure word/2 in compile_grammar.pl
 */
...
public class PRED_word_2 extends Predicate {
    static SymbolTerm f1 = SymbolTerm.makeSymbol("word", 2);
    static SymbolTerm f3 = SymbolTerm.makeSymbol(":", 2);
    static SymbolTerm s4 = SymbolTerm.makeSymbol("shef.nlp.supple.prolog.cafe");

    public Term arg1, arg2;

    public PRED_word_2(Term a1, Term a2, Predicate cont) {
        arg1 = a1; 
        arg2 = a2; 
        this.cont = cont;
    }
