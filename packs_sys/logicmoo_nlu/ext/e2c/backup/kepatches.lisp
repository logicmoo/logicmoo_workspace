...
(cyc-assert '(#$genls #$UnaryMicrotheoryFunction #$IndividualDenotingFunction) #$UniversalVocabularyMt)
(cyc-assert '(#$equiv (#$isa ?FUNCT #$UnaryMicrotheoryFunction)(#$and (#$isa ?FUNCT #$UnaryFunction)(#$resultIsa ?FUNCT #$Microtheory))) #$UniversalVocabularyMt  '(:DIRECTION :FORWARD))
