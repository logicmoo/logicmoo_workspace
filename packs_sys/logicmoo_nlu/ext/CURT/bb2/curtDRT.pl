...
:- use_module(lambdaDRT,[lambdaDRT/3]).
...
:- dynamic history/1, interpretations/1 , readings/1.
...
info:-
   format('~n> ---------------------------------------------------------- <',[]),
   format('~n> curtDRT.pl, by Patrick Blackburn and Johan Bos             <',[]),
   format('~n>                                                            <',[]),
