/*************************************************************************
         ...
         name: betaConversion3.pl (Chapter 2)
      version: July 13, 2001
  description: Implementation of Beta-Conversion (verbose)
...
betaConvert(Expression,_,Stack):-
	myformat('~n      Expr.: ~p~n      Stack: ~p',[Expression, Stack]), 
	fail.
