...
#ifndef soapcandc_bindingObject_H
#define soapcandc_bindingObject_H
#include "soapH.h"
...
class candc_bindingService : public soap
{    public:
	candc_bindingService()
