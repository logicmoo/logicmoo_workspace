...
SOAP_SOURCE_STAMP("@(#) soapC.c ver 2.8.12 2014-06-15 08:23:04 GMT")
...
{	(void)type;
	...
	case SOAP_TYPE_PointerToxsd__double:
		return soap_in_PointerToxsd__double(soap, NULL, NULL, "xsd:double");
...
{	(void)tag;
	...
	case SOAP_TYPE_PointerToxsd__double:
		return soap_out_PointerToxsd__double(soap, tag, id, (double *const*)ptr, "xsd:double");
	case SOAP_TYPE__QName:
...
SOAP_FMAC3 void SOAP_FMAC4 soap_markelement(struct soap *soap, const void *ptr, int type)
{
	...
	case SOAP_TYPE_ns__addResponse:
		...
		break;
	case SOAP_TYPE_PointerToxsd__double:
		soap_serialize_PointerToxsd__double(soap, (double *const*)ptr);
		break;
	case SOAP_TYPE__QName:
...
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_embedded(soap, &a->a, SOAP_TYPE_xsd__double);
	soap_embedded(soap, &a->b, SOAP_TYPE_xsd__double);
}
...
{
	(void)soap; (void)a; /* appease -Wall -Werror */
	soap_serialize_PointerToxsd__double(soap, &a->result);
}
...
SOAP_FMAC3 int SOAP_FMAC4 soap_out_ns__addResponse(struct soap *soap, const char *tag, int id, const struct ns__addResponse *a, const char *type)
{
	...
	if (soap_element_begin_out(soap, tag, soap_embedded_id(soap, id, a, SOAP_TYPE_ns__addResponse), type))
		return soap->error;
	if (soap_out_PointerToxsd__double(soap, "result", -1, &a->result, ""))
		return soap->error;
	return soap_element_end_out(soap, tag);
}
	...
	if (soap->body && !*soap->href)
	{
		...
		{	soap->error = SOAP_TAG_MISMATCH;
			if (soap_flag_result && soap->error == SOAP_TAG_MISMATCH)
				if (soap_in_PointerToxsd__double(soap, "result", &a->result, "xsd:double"))
				{	soap_flag_result--;
					continue;
				}
			if (soap->error == SOAP_TAG_MISMATCH)
...
SOAP_FMAC3 void SOAP_FMAC4 soap_serialize_PointerToxsd__double(struct soap *soap, double *const*a)
{
	soap_reference(soap, *a, SOAP_TYPE_xsd__double);
}

SOAP_FMAC3 int SOAP_FMAC4 soap_out_PointerToxsd__double(struct soap *soap, const char *tag, int id, double *const*a, const char *type)
{
	id = soap_element_id(soap, tag, id, *a, NULL, 0, type, SOAP_TYPE_xsd__double);
	if (id < 0)
		return soap->error;
	return soap_out_xsd__double(soap, tag, id, *a, type);
}

SOAP_FMAC3 double ** SOAP_FMAC4 soap_in_PointerToxsd__double(struct soap *soap, const char *tag, double **a, const char *type)
{
	if (soap_element_begin_in(soap, tag, 1, NULL))
		return NULL;
	if (!a)
	...
	*a = NULL;
	if (!soap->null && *soap->href != '#')
	{	soap_revert(soap);
		if (!(*a = soap_in_xsd__double(soap, tag, *a, type)))
			return NULL;
	}
	else
	{	a = (double **)soap_id_lookup(soap, soap->href, (void**)a, SOAP_TYPE_xsd__double, sizeof(double), 0);
		if (soap->body && soap_element_end_in(soap, tag))
			return NULL;
	}
	return a;
...
SOAP_FMAC3 int SOAP_FMAC4 soap_put_PointerToxsd__double(struct soap *soap, double *const*a, const char *tag, const char *type)
{
	register int id = soap_embed(soap, (void*)a, NULL, 0, tag, SOAP_TYPE_PointerToxsd__double);
	if (soap_out_PointerToxsd__double(soap, tag?tag:"xsd:double", id, a, type))
		return soap->error;
	return soap_putindependent(soap);
}

SOAP_FMAC3 double ** SOAP_FMAC4 soap_get_PointerToxsd__double(struct soap *soap, double **p, const char *tag, const char *type)
{
	if ((p = soap_in_PointerToxsd__double(soap, tag, p, type)))
		if (soap_getindependent(soap))
			return NULL;
	return p;
}
