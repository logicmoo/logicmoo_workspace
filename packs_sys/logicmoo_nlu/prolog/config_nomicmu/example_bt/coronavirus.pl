...
% %% https://github.com/logicmoo/logicmoo_nlu/blob/master/prolog/episodic_memory/adv_axiom.pl
% %% https://github.com/logicmoo/logicmoo_nlu/blob/master/prolog/episodic_memory/adv_implies.pl
