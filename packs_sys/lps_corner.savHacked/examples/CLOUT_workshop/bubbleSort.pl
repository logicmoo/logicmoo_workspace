...
d(swap(_,Pos1,_,Pos2),[from:[FX,40],to:[TX,40],type:arrow, label:'swap!', biDirectional]) :- FX is Pos1*30, TX is Pos2*30.
d(timeless,[type:rectangle, label:'Bubble Sort', fillColor:white, from:[0,0], to:[150,140]]).
*/
/** <examples>
?- go(Timeline).
*/