...
'surface-macro'([assertedFormula, _G17113], [knows, 'SigmaSystem', _G17113]).
...
'browser-only'('SUMO-BasedProject').

'browser-only'('SUMOConstant').

'browser-only'('SUMOExpression').

'browser-only'('SUMOFormula').

'browser-only'('SUMOIndexedTerm').

'browser-only'('SUMOAssertionDirection').

'browser-only'('SUMOlist').

'browser-only'(cyckifrovenotes).

'browser-only'('SUMOlistsMt').

'browser-only'('SUMOSystemAtom').

'browser-only'('SUMOSystemInteger').

'browser-only'(prettyName).

'browser-only'('SUMOSystemKeyword').

'browser-only'('SUMOSystemList').

'browser-only'('SUMOSystemRealNumber').

'browser-only'('SUMOSystemString').

'browser-only'('SUMOSystemSymbol').

'browser-only'('SUMOTerm').
...
'surface-word'('SUMOELVariable', 'Entity').

'surface-word'('SUMOFormula', 'Formula').
...
'surface-word'('SUMOSystemRealNumber', 'RealNumber').
...
'surface-instance'(queryyn, 'PropositionalConnective').
