% Prolog translation of SUMO Version 1.34, Downloaded and Translated June 25, 2002
...
domain(subclass, 1, 'Class'):-true.
domain(subclass, 2, 'Class'):-true.
...
superclasses and subclasses."):-true.
...
with the functions &%UnionFn, &%IntersectionFn, etc."):-true.
...
domain('domainSubclass', 3, 'Class'):-true.
...
=>([range, '?FUNCTION', '?CLASS'], [forall, ['@ROW'], [=>, [equal, ['AssignmentFn', '?FUNCTION', '@ROW'], '?VALUE'], [instance, '?VALUE', '?CLASS']]]):-true.
...
'domainSubclass'('rangeSubclass', 2, 'Class'):-true.
...
=>(['rangeSubclass', '?FUNCTION', '?CLASS'], [forall, ['@ROW'], [=>, [equal, ['AssignmentFn', '?FUNCTION', '@ROW'], '?VALUE'], [subclass, '?VALUE', '?CLASS']]]):-true.
instance('DomainFn', 'UnaryFunction'):-true.
domain('DomainFn', 1, 'BinaryRelation'):-true.
range('DomainFn', 'Class'):-true.
documentation('DomainFn', "The domain of a &%BinaryRelation ?REL is
the &%Class of all things that bear ?REL to something."):-true.
...
range('RangeFn', 'Class'):-true.
documentation('RangeFn', "The range of a &%BinaryRelation ?REL is the
&%Class of all things such that something bears ?REL to them."):-true.
...
domain(disjoint, 1, 'Class'):-true.
domain(disjoint, 2, 'Class'):-true.
...
domain('PowerSetFn', 1, 'Class'):-true.
'rangeSubclass'('PowerSetFn', 'Class'):-true.
documentation('PowerSetFn', "(&%PowerSetFn ?CLASS) maps the &%Class 
?CLASS to the &%Class of all &%subclasses of ?CLASS."):-true.
...
instance(part, 'BinaryPredicate'):-true.
...
instance(member, 'BinaryPredicate'):-true.
instance(member, 'SpatialRelation'):-true.
...
subclass('Sentence', 'LinguisticExpression'):-true.
...
=>([instance, '?SENT', 'Sentence'], [exists, ['?PROP'], [and, [instance, '?PROP', 'Proposition'], ['containsInformation', '?SENT', '?PROP']]]):-true.
...
=>([instance, '?REL', 'TotalValuedRelation'], [forall, ['@ROW'], [exists, ['?ITEM'], [holds, '?REL', '@ROW', '?ITEM']]]):-true.
...
instance(probability, 'ProbabilityRelation'):-true.
instance(probability, 'BinaryPredicate'):-true.
domain(probability, 1, 'Formula'):-true.
domain(probability, 2, 'RealNumber'):-true.
instance(probability, 'AsymmetricRelation'):-true.
instance(probability, 'IrreflexiveRelation'):-true.
documentation(probability, "One of the basic &%ProbabilityRelations, 
&%probability is used to state the a priori probability of a state of 
affairs.  (&%probability ?FORMULA ?NUMBER) means that the state of 
affairs denoted by ?FORMULA has the a priori probability of ?NUMBER."):-true.
...
=>([and, ['increasesLikelihood', '?FORMULA1', '?FORMULA2'], [probability, '?FORMULA2', '?NUMBER1'], ['conditionalProbability', '?FORMULA1', '?FORMULA2', '?NUMBER2']], ['greaterThan', '?NUMBER2', '?NUMBER1']):-true.
...
likely to be true if ?FORMULA1 is true."):-true.
=>([and, ['decreasesLikelihood', '?FORMULA1', '?FORMULA2'], [probability, '?FORMULA2', '?NUMBER1'], ['conditionalProbability', '?FORMULA1', '?FORMULA2', '?NUMBER2']], ['lessThan', '?NUMBER2', '?NUMBER1']):-true.
...
=>([and, ['independentProbability', '?FORMULA1', '?FORMULA2'], [probability, '?FORMULA2', '?NUMBER1'], ['conditionalProbability', '?FORMULA1', '?FORMULA2', '?NUMBER2']], [equal, '?NUMBER2', '?NUMBER1']):-true.
...
=>([instance, '?LIST', 'List'], [exists, ['?NUMBER1'], [not, [exists, ['?ITEM1'], [and, [equal, ['ListOrderFn', '?LIST', '?NUMBER1'], '?ITEM1'], [forall, ['?NUMBER2'], [=>, [and, [instance, '?NUMBER2', 'PositiveInteger'], ['lessThan', '?NUMBER2', '?NUMBER1']], [exists, ['?ITEM2'], [equal, ['ListOrderFn', '?LIST', '?NUMBER2'], '?ITEM2']]]]]]]]):-true.
...
documentation('ListOrderFn', "(&%ListOrderFn ?NUMBER ?LIST) denotes the item 
...
value &%Tuesday."):-true.
=>([forall, ['?NUMBER'], [equal, ['ListOrderFn', '?LIST1', '?NUMBER'], ['ListOrderFn', '?LIST2', '?NUMBER']]], [equal, '?LIST1', '?LIST2']):-true.
=>([domain, '?REL', '?NUMBER', '?CLASS'], [forall, ['@ROW'], [=>, [holds, '?REL', '@ROW'], [instance, ['ListOrderFn', ['ListFn', '@ROW'], '?NUMBER'], '?CLASS']]]):-true.
=>(['domainSubclass', '?REL', '?NUMBER', '?CLASS'], [forall, ['@ROW'], [=>, [holds, '?REL', '@ROW'], [subclass, ['ListOrderFn', ['ListFn', '@ROW'], '?NUMBER'], '?CLASS']]]):-true.
...
n-tuple with at most one range element.  Note that the range is a &%Class, 
and each element of the range is an instance of the &%Class."):-true.
...
assumed to be &%Sets without contradiction."):-true.
...
always an instance of the &%Class."):-true.
...
domain('reflexiveOn', 2, 'Class'):-true.
...
domain('irreflexiveOn', 2, 'Class'):-true.
...
domain('partialOrderingOn', 2, 'Class'):-true.
...
domain('totalOrderingOn', 2, 'Class'):-true.
...
domain('trichotomizingOn', 2, 'Class'):-true.
...
domain('equivalenceRelationOn', 2, 'Class'):-true.
...
instance('NumberE', 'RealNumber'):-true.
...
domain('UnionFn', 1, 'Class'):-true.
domain('UnionFn', 2, 'Class'):-true.
range('UnionFn', 'Class'):-true.
...
two &%Classes just in case it is an instance of either &%Class."):-true.
...
domain('IntersectionFn', 1, 'Class'):-true.
domain('IntersectionFn', 2, 'Class'):-true.
range('IntersectionFn', 'Class'):-true.
...
domain('RelativeComplementFn', 1, 'Class'):-true.
domain('RelativeComplementFn', 2, 'Class'):-true.
range('RelativeComplementFn', 'Class'):-true.
...
domain('ComplementFn', 1, 'Class'):-true.
range('ComplementFn', 'Class'):-true.
...
'domainSubclass'('GeneralizedUnionFn', 1, 'Class'):-true.
range('GeneralizedUnionFn', 'Class'):-true.
...
'domainSubclass'('GeneralizedIntersectionFn', 1, 'Class'):-true.
range('GeneralizedIntersectionFn', 'Class'):-true.
...
instances of the original &%Class."):-true.
...
domain('CardinalityFn', 1, ['UnionFn', 'Class', 'Collection']):-true.
domain('CardinalityFn', 2, 'Number'):-true.
documentation('CardinalityFn', "(CardinalityFn ?CLASS) returns the 
number of instances in the &%Class or &%Collection ?CLASS."):-true.
...
subclass('PairwiseDisjointClass', 'Class'):-true.
...
subclass('MutuallyDisjointClass', 'Class'):-true.
...
range('IntervalFn', 'ConstantQuantity'):-true.
...
to the &%ConstantQuantity that is an interval from the first &%ConstantQuantity 
to the second &%ConstantQuantity.  For example, (&%IntervalFn (&%MeasureFn 8 &%Meter) 
(&%MeasureFn 14 &%Meter)) would return the &%ConstantQuantity of being between 8 and 
14 meters in length."):-true.
...
instance('Meter', 'LengthMeasure'):-true.
...
instance('Ampere', 'FunctionQuantity'):-true.
...
instance('KelvinDegree', 'TemperatureMeasure'):-true.
...
instance('Mole', 'MassMeasure'):-true.
...
particles."):-true.
instance('Candela', 'FunctionQuantity'):-true.
...
instance('Liter', 'VolumeMeasure'):-true.
...
instance('Centimeter', 'LengthMeasure'):-true.
...
instance('Radian', 'PlaneAngleMeasure'):-true.
...
instance('Steradian', 'SolidAngleMeasure'):-true.
...
m^2/m^2 = 1."):-true.
instance('Hertz', 'TimeDependentQuantity'):-true.
...
instance('Newton', 'FunctionQuantity'):-true.
...
instance('Pascal', 'FunctionQuantity'):-true.
...
= m^(-1)*kg*s^(-2)."):-true.
instance('Joule', 'FunctionQuantity'):-true.
...
m^2*kg*s^(-2)."):-true.
instance('Watt', 'FunctionQuantity'):-true.
...
instance('Coulomb', 'TimeDependentQuantity'):-true.
...
instance('Volt', 'FunctionQuantity'):-true.
...
m^2*kg*s^(-3)*A^(-1)."):-true.
instance('Farad', 'FunctionQuantity'):-true.
...
instance('Ohm', 'FunctionQuantity'):-true.
...
m^2*kg*s^(-3)*A^(-2)."):-true.
instance('Siemens', 'FunctionQuantity'):-true.
...
instance('Weber', 'FunctionQuantity'):-true.
...
instance('Tesla', 'FunctionQuantity'):-true.
...
kg*s^(-2)*A^(-1)."):-true.
instance('Henry', 'FunctionQuantity'):-true.
...
instance('CelsiusDegree', 'TemperatureMeasure'):-true.
...
instance('Lumen', 'FunctionQuantity'):-true.
...
cd*sr = cd * 1."):-true.
instance('Lux', 'FunctionQuantity'):-true.
...
m^(-2)*cd."):-true.
instance('Becquerel', 'TimeDependentQuantity'):-true.
...
instance('Gray', 'FunctionQuantity'):-true.
...
= m^2*s^(-2)."):-true.
instance('Sievert', 'FunctionQuantity'):-true.
...
instance('DayDuration', 'TimeDuration'):-true.
...
instance('HourDuration', 'TimeDuration'):-true.
...
instance('MinuteDuration', 'TimeDuration'):-true.
...
instance('WeekDuration', 'TimeDuration'):-true.
...
instance('YearDuration', 'TimeDuration'):-true.
...
instance('ElectronVolt', 'FunctionQuantity'):-true.
...
instance('Angstrom', 'LengthMeasure'):-true.
...
instance('Foot', 'LengthMeasure'):-true.
...
instance('Inch', 'LengthMeasure'):-true.
...
instance('Mile', 'LengthMeasure'):-true.
...
instance('UnitedStatesGallon', 'VolumeMeasure'):-true.
...
instance('Quart', 'VolumeMeasure'):-true.
...
instance('Pint', 'VolumeMeasure'):-true.
...
instance('Cup', 'VolumeMeasure'):-true.
...
instance('Ounce', 'VolumeMeasure'):-true.
...
instance('UnitedKingdomGallon', 'VolumeMeasure'):-true.
...
instance('AtomGram', 'MassMeasure'):-true.
...
instance('PoundMass', 'MassMeasure'):-true.
...
instance('Slug', 'MassMeasure'):-true.
...
instance('RankineDegree', 'TemperatureMeasure'):-true.
...
instance('FahrenheitDegree', 'TemperatureMeasure'):-true.
...
instance('PoundForce', 'FunctionQuantity'):-true.
...
instance('Calorie', 'FunctionQuantity'):-true.
...
instance('BritishThermalUnit', 'FunctionQuantity'):-true.
...
instance('AngularDegree', 'PlaneAngleMeasure'):-true.
...
instance('EuroDollar', 'CurrencyMeasure'):-true.
...
instance('EuroCent', 'CurrencyMeasure'):-true.
...
instance('KiloByte', 'InformationMeasure'):-true.
...
instance('MegaByte', 'InformationMeasure'):-true.
...
instance(height, 'SingleValuedRelation'):-true.
subrelation(height, length):-true.
documentation(height, "&%BinaryPredicate that is used to state the &%length
...
domain(duration, 1, 'TimePosition'):-true.
...
=>([instance, '?INTERVAL', 'TimeInterval'], [exists, ['?DURATION'], [duration, '?INTERVAL', '?DURATION']]):-true.
=>([instance, '?POINT', 'TimePoint'], [not, [exists, ['?DURATION'], [duration, '?POINT', '?DURATION']]]):-true.
...
=>([instance, '?YEAR', 'Year'], [duration, '?YEAR', 'YearDuration']):-true.
...
=>([instance, '?DAY', 'Day'], [duration, '?DAY', 'DayDuration']):-true.
...
=>([instance, '?WEEK', 'Week'], [duration, '?WEEK', 'WeekDuration']):-true.
...
=>([instance, '?HOUR', 'Hour'], [duration, '?HOUR', 'HourDuration']):-true.
...
=>([instance, '?MINUTE', 'Minute'], [duration, '?MINUTE', 'MinuteDuration']):-true.
...
=>([instance, '?SECOND', 'Second'], [duration, '?SECOND', 'SecondDuration']):-true.
...
=>([forall, ['?OBJ3'], [=>, [part, '?OBJ3', '?OBJ1'], ['overlapsSpatially', '?OBJ3', '?OBJ2']]], [part, '?OBJ1', '?OBJ2']):-true.
...
instance('superficialPart', 'BinaryPredicate'):-true.
instance('superficialPart', 'SpatialRelation'):-true.
...
subclass('Hole', 'SelfConnectedObject'):-true.
'relatedInternalConcept'('Hole', hole):-true.
...
instance(fills, 'BinaryPredicate'):-true.
instance(fills, 'SpatialRelation'):-true.
...
instance('completelyFills', 'BinaryPredicate'):-true.
instance('completelyFills', 'SpatialRelation'):-true.
...
instance('partiallyFills', 'BinaryPredicate'):-true.
...
instance('properlyFills', 'BinaryPredicate'):-true.
instance('properlyFills', 'SpatialRelation'):-true.
...
subclass('Graduation', 'OrganizationalProcess'):-true.
documentation('Graduation', "The &%IntentionalProcess of graduating 
from an &%EducationalOrganization."):-true.
=>([and, [instance, '?GRAD', 'Graduation'], [instance, '?ORG', 'EducationalOrganization'], [agent, '?GRAD', '?ORG'], [patient, '?GRAD', '?PERSON']], ['holdsDuring', ['ImmediateFutureFn', ['WhenFn', '?GRAD']], [not, [member, '?PERSON', '?ORG']]]):-true.
subclass('Matriculation', 'OrganizationalProcess'):-true.
disjoint('Matriculation', 'Graduation'):-true.
documentation('Graduation', "The &%IntentionalProcess of joining an 
&%EducationalOrganization as a student."):-true.
=>([and, [instance, '?MAT', 'Matriculation'], [instance, '?ORG', 'EducationalOrganization'], [agent, '?GRAD', '?ORG'], [patient, '?GRAD', '?PERSON']], ['holdsDuring', ['ImmediateFutureFn', ['WhenFn', '?MAT']], [member, '?PERSON', '?ORG']]):-true.
...
subclass('Hiring', 'OrganizationalProcess'):-true.
...
subclass('TerminatingEmployment', 'OrganizationalProcess'):-true.
disjoint('TerminatingEmployment', 'Hiring'):-true.
...
via a &%ContentBearingObject."):-true.
...
arrive soon."):-true.
=>([and, [instance, '?STATE', 'Stating'], [agent, '?STATE', '?AGENT'], [patient, '?STATE', '?FORMULA']], ['holdsDuring', ['WhenFn', '?STATE'], [believes, '?AGENT', '?FORMULA']]):-true.
...
=>([and, [instance, '?COMMIT', 'Committing'], [patient, '?COMMIT', '?FORMULA']], ['modalAttribute', '?COMMIT', 'Promise']):-true.
...
domain('developmentalForm', 1, ['UnionFn', 'Organism', 'AnatomicalStructure']):-true.
...
=>([and, [instance, '?PART', 'BodyPart'], [part, '?PART', '?ORGANISM']], [not, [exists, ['?PROC'], [and, [instance, '?PROC', 'PathologicProcess'], [result, '?PROC', '?PART']]]]):-true.
...
documentation('Text', "A &%Phrase, &%Sentence or set of &%Sentences 
that perform a specific function related to &%Communication, e.g. 
express a discourse about a particular topic."):-true.
=>([instance, '?TEXT', 'Text'], [exists, ['?PART1', '?PART2'], [and, [part, '?PART1', '?TEXT'], [part, '?PART2', '?TEXT'], [instance, '?PART1', 'Sentence'], [instance, '?PART2', 'Sentence'], [not, [equal, '?PART1', '?PART2']]]]):-true.
...
subclass('Position', 'CognitiveAgent'):-true.
'relatedInternalConcept'('Position', 'occupiesPosition'):-true.
...
=>(['occupiesPosition', '?PERSON', '?POSITION', '?ORG'], [employs, '?ORG', '?PERSON']):-true.
...
instance('TruthFn', 'UnaryFunction'):-true.
domain('TruthFn', 1, 'Sentence'):-true.
domain('TruthFn', 2, 'TruthValue'):-true.
...
=>([and, [attribute, '?PERSON', '?ATTRIBUTE'], [instance, '?ATTRIBUTE', 'SocialRole']], [instance, '?PERSON', 'CognitiveAgent']):-true.
...
subclass('ContestAttribute', 'NormativeAttribute'):-true.
...
of these &%Attributes are winning, losing, won, lost, struggling, etc."):-true.
...
this &%Class."):-true.
instance('Permission', 'NormativeAttribute'):-true.
...
instance('Obligation', 'NormativeAttribute'):-true.
...
'contraryAttribute'('Red', 'Blue'):-true.
'contraryAttribute'('Red', 'Yellow'):-true.
documentation('Red', "The &%Attribute of redness."):-true.
instance('Blue', 'PrimaryColor'):-true.
'contraryAttribute'('Blue', 'Yellow'):-true.
