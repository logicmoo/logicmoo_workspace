0.000519555899074::advisedby(Fold,A,B).
0.355260026393903::advisedby(Fold,A,B) :- professor(Fold,B), hidden_1(Fold,A,B).
0.674887551891037::hidden_1(Fold,A,B) :- student(Fold,A), hidden_1_1(Fold,A,B).
0.224808046848506::hidden_1(Fold,A,B) :- student(Fold,A), hidden_1_2(Fold,A,B).
0.54793260715241::hidden_1_1(Fold,A,B) :- hasposition(Fold,B,faculty).
0.569237455662933::hidden_1_1(Fold,A,B) :- inphase(Fold,A,post_quals).
0.895130197385367::hidden_1_1(Fold,A,B) :- taughtby(Fold,C,B,D), hidden_1_1_1(Fold,A,B,C,D).
0.999496513659875::hidden_1_1(Fold,A,B) :- publication(Fold,C,A), hidden_1_1_2(Fold,A,B,C).
0.314824810476078::hidden_1_2(Fold,A,B) :- publication(Fold,C,A), hidden_1_2_1(Fold,A,B,C).
0.906659483713246::hidden_1_1_1(Fold,A,B,C,D) :- ta(Fold,C,A,D).
0.698393544552463::hidden_1_1_2(Fold,A,B,C) :- publication(Fold,C,B).
0.663989356737292::hidden_1_2_1(Fold,A,B,C) :- publication(Fold,C,D), hidden_1_2_1_1(Fold,A,B,C,D).
0.499566133899543::hidden_1_2_1_1(Fold,A,B,C,D) :- D\==A, hidden_1_2_1_1_1(Fold,A,B,C,D).
0.342494060451145::hidden_1_2_1_1_1(Fold,A,B,C,D) :- D\==B, hidden_1_2_1_1_1_1(Fold,A,B,C,D).
0.34965206983709::hidden_1_2_1_1_1_1(Fold,A,B,C,D) :- inphase(Fold,A,P), hidden_1_2_1_1_1_1_1(Fold,A,B,C,D,P).
0.08636108660011::hidden_1_2_1_1_1_1(Fold,A,B,C,D) :- yearsinprogram(Fold,A,Y), hidden_1_2_1_1_1_1_2(Fold,A,B,C,D,Y).
0.321752643473453::hidden_1_2_1_1_1_1_1(Fold,A,B,C,D,P) :- inphase(Fold,D,P).
0.344211662884266::hidden_1_2_1_1_1_1_2(Fold,A,B,C,D,Y) :- yearsinprogram(Fold,D,Y).
