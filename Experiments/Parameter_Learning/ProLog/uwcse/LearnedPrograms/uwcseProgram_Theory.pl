0.000446711561743::advisedby(Fold,A,B).
0.913065995661541::advisedby(Fold,A,B) :- professor(Fold,B), hidden_1(Fold,A,B).
0.736293302144719::hidden_1(Fold,A,B) :- student(Fold,A), hidden_1_1(Fold,A,B).
0.634467561921169::hidden_1(Fold,A,B) :- student(Fold,A), hidden_1_2(Fold,A,B).
0.093979966546177::hidden_1_1(Fold,A,B) :- hasposition(Fold,B,faculty).
0.072973423097927::hidden_1_1(Fold,A,B) :- inphase(Fold,A,post_quals).
0.993830851284505::hidden_1_1(Fold,A,B) :- taughtby(Fold,C,B,D), hidden_1_1_1(Fold,A,B,C,D).
0.999988697013878::hidden_1_1(Fold,A,B) :- publication(Fold,C,A), hidden_1_1_2(Fold,A,B,C).
0.305563789768067::hidden_1_2(Fold,A,B) :- publication(Fold,C,A), hidden_1_2_1(Fold,A,B,C).
0.696229291154259::hidden_1_1_1(Fold,A,B,C,D) :- ta(Fold,C,A,D).
0.446111621622407::hidden_1_1_2(Fold,A,B,C) :- publication(Fold,C,B).
0.258349167181532::hidden_1_2_1(Fold,A,B,C) :- publication(Fold,C,D), hidden_1_2_1_1(Fold,A,B,C,D).
0.117154348215826::hidden_1_2_1_1(Fold,A,B,C,D) :- D\==A, hidden_1_2_1_1_1(Fold,A,B,C,D).
0.905798171933221::hidden_1_2_1_1_1(Fold,A,B,C,D) :- D\==B, hidden_1_2_1_1_1_1(Fold,A,B,C,D).
0.518253643655962::hidden_1_2_1_1_1_1(Fold,A,B,C,D) :- inphase(Fold,A,P), hidden_1_2_1_1_1_1_1(Fold,A,B,C,D,P).
0.360418533335261::hidden_1_2_1_1_1_1(Fold,A,B,C,D) :- yearsinprogram(Fold,A,Y), hidden_1_2_1_1_1_1_2(Fold,A,B,C,D,Y).
0.278887534338496::hidden_1_2_1_1_1_1_1(Fold,A,B,C,D,P) :- inphase(Fold,D,P).
0.720715425023941::hidden_1_2_1_1_1_1_2(Fold,A,B,C,D,Y) :- yearsinprogram(Fold,D,Y).
