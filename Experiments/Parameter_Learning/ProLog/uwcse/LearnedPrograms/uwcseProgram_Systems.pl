0.0::advisedby(Fold,A,B).
0.966364983322073::advisedby(Fold,A,B) :- professor(Fold,B), hidden_1(Fold,A,B).
0.87153595131489::hidden_1(Fold,A,B) :- student(Fold,A), hidden_1_1(Fold,A,B).
0.678197839525231::hidden_1(Fold,A,B) :- student(Fold,A), hidden_1_2(Fold,A,B).
0.085034729275349::hidden_1_1(Fold,A,B) :- hasposition(Fold,B,faculty).
0.084466488897533::hidden_1_1(Fold,A,B) :- inphase(Fold,A,post_quals).
0.97292996010257::hidden_1_1(Fold,A,B) :- taughtby(Fold,C,B,D), hidden_1_1_1(Fold,A,B,C,D).
0.999999473651174::hidden_1_1(Fold,A,B) :- publication(Fold,C,A), hidden_1_1_2(Fold,A,B,C).
0.531230508235815::hidden_1_2(Fold,A,B) :- publication(Fold,C,A), hidden_1_2_1(Fold,A,B,C).
0.708840703715591::hidden_1_1_1(Fold,A,B,C,D) :- ta(Fold,C,A,D).
0.41488057562976::hidden_1_1_2(Fold,A,B,C) :- publication(Fold,C,B).
0.531288447311316::hidden_1_2_1(Fold,A,B,C) :- publication(Fold,C,D), hidden_1_2_1_1(Fold,A,B,C,D).
0.735983145420489::hidden_1_2_1_1(Fold,A,B,C,D) :- D\==A, hidden_1_2_1_1_1(Fold,A,B,C,D).
0.156523395252652::hidden_1_2_1_1_1(Fold,A,B,C,D) :- D\==B, hidden_1_2_1_1_1_1(Fold,A,B,C,D).
0.358235500460413::hidden_1_2_1_1_1_1(Fold,A,B,C,D) :- inphase(Fold,A,P), hidden_1_2_1_1_1_1_1(Fold,A,B,C,D,P).
0.409691918001331::hidden_1_2_1_1_1_1(Fold,A,B,C,D) :- yearsinprogram(Fold,A,Y), hidden_1_2_1_1_1_1_2(Fold,A,B,C,D,Y).
0.288983798921677::hidden_1_2_1_1_1_1_1(Fold,A,B,C,D,P) :- inphase(Fold,D,P).
0.209886468778213::hidden_1_2_1_1_1_1_2(Fold,A,B,C,D,Y) :- yearsinprogram(Fold,D,Y).
