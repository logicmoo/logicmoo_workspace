0.000369787947551::advisedby(Fold,A,B).
0.523196334837883::advisedby(Fold,A,B) :- professor(Fold,B), hidden_1(Fold,A,B).
0.988916781675697::hidden_1(Fold,A,B) :- student(Fold,A), hidden_1_1(Fold,A,B).
0.449804821458772::hidden_1(Fold,A,B) :- student(Fold,A), hidden_1_2(Fold,A,B).
0.117018733495745::hidden_1_1(Fold,A,B) :- hasposition(Fold,B,faculty).
0.121249197698487::hidden_1_1(Fold,A,B) :- inphase(Fold,A,post_quals).
0.713323188907881::hidden_1_1(Fold,A,B) :- taughtby(Fold,C,B,D), hidden_1_1_1(Fold,A,B,C,D).
0.999952872383109::hidden_1_1(Fold,A,B) :- publication(Fold,C,A), hidden_1_1_2(Fold,A,B,C).
0.755154584607077::hidden_1_2(Fold,A,B) :- publication(Fold,C,A), hidden_1_2_1(Fold,A,B,C).
0.852860130970877::hidden_1_1_1(Fold,A,B,C,D) :- ta(Fold,C,A,D).
0.981739623530919::hidden_1_1_2(Fold,A,B,C) :- publication(Fold,C,B).
0.910653045278411::hidden_1_2_1(Fold,A,B,C) :- publication(Fold,C,D), hidden_1_2_1_1(Fold,A,B,C,D).
0.352618142303262::hidden_1_2_1_1(Fold,A,B,C,D) :- D\==A, hidden_1_2_1_1_1(Fold,A,B,C,D).
0.300613282519812::hidden_1_2_1_1_1(Fold,A,B,C,D) :- D\==B, hidden_1_2_1_1_1_1(Fold,A,B,C,D).
0.525697724316715::hidden_1_2_1_1_1_1(Fold,A,B,C,D) :- inphase(Fold,A,P), hidden_1_2_1_1_1_1_1(Fold,A,B,C,D,P).
0.7892239465362::hidden_1_2_1_1_1_1(Fold,A,B,C,D) :- yearsinprogram(Fold,A,Y), hidden_1_2_1_1_1_1_2(Fold,A,B,C,D,Y).
0.243012029424831::hidden_1_2_1_1_1_1_1(Fold,A,B,C,D,P) :- inphase(Fold,D,P).
0.313188882472537::hidden_1_2_1_1_1_1_2(Fold,A,B,C,D,Y) :- yearsinprogram(Fold,D,Y).
