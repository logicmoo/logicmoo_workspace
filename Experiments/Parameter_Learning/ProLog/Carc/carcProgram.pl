...
t(_)::active(Fold,Model) :- ames(Fold,Model).
t(_)::active(Fold,Model) :- has_property(Fold,Model,salmonella,p).
t(_)::active(Fold,Model) :- ashby_alert(Fold,Model,amino,A),hidden_1(Fold,Model,A).
t(_)::active(Fold,Model) :- ashby_alert(Fold,Model,di10,B).
t(_)::active(Fold,Model) :- ashby_alert(Fold,Model,nitro,C),hidden_2(Fold,Model,C).
t(_)::active(Fold,Model) :- ind(Fold,Model,amino,D),hidden_3(Fold,Model,D).
t(_)::active(Fold,Model) :- atm(Fold,Model,E,c,22,F),hidden_4(Fold,Model,E,F).
t(_)::active(Fold,Model) :- atm(Fold,Model,G,c,22,H),hidden_5(Fold,Model,G,H).
t(_)::active(Fold,Model) :- nitro(Fold,Model,Y).
t(_)::active(Fold,Model) :- amine(Fold,Model,Z).
t(_)::active(Fold,Model) :- phenol(Fold,Model,A1).
t(_)::hidden_1(Fold,Model,A) :- connected(Fold,Model,A,Z).
t(_)::hidden_1(Fold,Model,A) :- connected(Fold,Model,Z,A),hidden_1_1(Fold,Model,Z,A).
t(_)::hidden_2(Fold,Model,C) :- connected(Fold,Model,C,B1).
t(_)::hidden_3(Fold,Model,D) :- ind(Fold,Model,di10,D).
t(_)::hidden_4(Fold,Model,E,F) :- atm(Fold,Model,C1,c,22,F),hidden_4_1(Fold,Model,E,C1,F).
t(_)::hidden_4(Fold,Model,E,F) :- atm(Fold,Model,D1,c,22,F),hidden_4_2(Fold,Model,E,D1,F).
t(_)::hidden_4(Fold,Model,E,F) :- atm(Fold,Model,E1,c,22,F),hidden_4_3(Fold,Model,E,E1,F).
t(_)::hidden_4(Fold,Model,E,F) :- symbond(Fold,Model,K,E,1).
t(_)::hidden_4(Fold,Model,E,F) :- symbond(Fold,Model,E1,E,7),hidden_4_4(Fold,Model,F,E1,E).
t(_)::hidden_5(Fold,Model,G,H) :- symbond(Fold,Model,O,G,1).
t(_)::hidden_1_1(Fold,Model,Z,A) :- connected(Fold,Model,Z,B1),hidden_1_1_1(Fold,Model,A,Z,B1).
t(_)::hidden_1_1(Fold,Model,Z,A) :- connected(Fold,Model,B1,Z),hidden_1_1_2(Fold,Model,A,B1,Z).
t(_)::hidden_4_1(Fold,Model,E,C1,F) :- symbond(Fold,Model,Q,C1,1).
t(_)::hidden_4_2(Fold,Model,E,D1,F) :- symbond(Fold,Model,F1,D1,1).
t(_)::hidden_4_3(Fold,Model,E,E1,F) :- symbond(Fold,Model,I1,E1,1).
t(_)::hidden_4_4(Fold,Model,F,E1,E) :- symbond(Fold,Model,E1,I1,1).
t(_)::hidden_4_4(Fold,Model,F,E1,E) :- symbond(Fold,Model,I,E1,7),hidden_4_4_1(Fold,Model,F,E,I,E1).
t(_)::hidden_1_1_1(Fold,Model,A,Z,B1) :- connected(Fold,Model,B1,Y),hidden_1_1_1_1(Fold,Model,A,Z,B1,Y).
t(_)::hidden_1_1_2(Fold,Model,A,B1,Z) :- connected(Fold,Model,B1,C).
t(_)::hidden_4_4_1(Fold,Model,F,E,I,E1) :- symbond(Fold,Model,I,M,1).
t(_)::hidden_4_4_1(Fold,Model,F,E,I,E1) :- symbond(Fold,Model,G,I,7),hidden_4_4_1_1(Fold,Model,F,E,E1,G,I).
t(_)::hidden_1_1_1_1(Fold,Model,A,Z,B1,Y) :- connected(Fold,Model,Y,C).
t(_)::hidden_4_4_1_1(Fold,Model,F,E,E1,G,I) :- symbond(Fold,Model,G,O,1).
t(_)::hidden_4_4_1_1(Fold,Model,F,E,E1,G,I) :- symbond(Fold,Model,D1,G,7),hidden_4_4_1_1_1(Fold,Model,F,E,E1,I,D1,G).
t(_)::hidden_4_4_1_1_1(Fold,Model,F,E,E1,I,D1,G) :- symbond(Fold,Model,D1,F1,1).
t(_)::hidden_4_4_1_1_1(Fold,Model,F,E,E1,I,D1,G) :- symbond(Fold,Model,C1,D1,7),hidden_4_4_1_1_1_1(Fold,Model,F,E,E1,I,G,C1,D1).
t(_)::hidden_4_4_1_1_1_1(Fold,Model,F,E,E1,I,G,C1,D1) :- symbond(Fold,Model,C1,Q,1).

connected(_Fold,_Model,Ring1,Ring2):-
        Ring1 \= Ring2,
        member(A,Ring1),
        member(A,Ring2), !.
