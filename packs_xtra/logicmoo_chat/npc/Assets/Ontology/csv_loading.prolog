...
load_special_csv_row(RowNumber,
   ...
   log(assert_kind_nouns(Kind, Singular, Plural)),
	 ...
	 assert_if_unew(declared_kind(Kind, kind)),
...
load_special_csv_row(_RowNumber, properties(Name, Visibility,
   ...
   assert_if_unew(declared_kind(Name, property)),
...
load_special_csv_row( _RowNumber, 
  relations( Name, 
    ...
    Inverse, Symmetric)) :-  
  begin( assert_if_unew(declared_kind(Name, relation)), 
    assert_if_unew(visibility(Name, Visibility)), 
...
load_special_csv_row(_RowNumber,
  ...
  forall(member(Kind, KindList), assert_if_unew(declared_kind(EntityName, Kind))), 
