...
convert_tree_to_tokens(Item,Item):- \+ atomic(Item),!.
convert_tree_to_tokens(['NP'|Items],X):- 
   convert_treel_to_tokens(Items,List),
   dbltok(List,X).
convert_tree_to_tokens([_,Item],X):- !, convert_tree_to_tokens(Item,X).
convert_tree_to_tokens(Items,List):-  is_list(Items),!,convert_treel_to_tokens(Items,List),!.
convert_tree_to_tokens(X,X):- !.

convert_treel_to_tokens(Items,List):- maplist(convert_tree_to_tokens,Items,List).
