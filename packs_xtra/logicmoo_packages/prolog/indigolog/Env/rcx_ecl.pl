...
%
%  FILE      : Env/rcx_ecl.pl
%  Time-stamp: <02/11/30 01:35:52 ssardina>
%
%  Author      : Sebastian Sardina
%  DESCRIPTION : Interface to communicate with the Lego RCX via ECLIPSE
...
%:- import retractall/1 from iso.

:- include(legorcx).  % System independent part
:- include(lego_ecl). % System dependent part for ECLIPSE
