%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%%
%
% FILE: Elevator-Vanilla/main2_swi.pl
%
...
%
%  This is example2 for the first IndiGolog code written by H. Levesque
%
...
:- ['../../Interpreters/indigolog-vanilla_swi'].
...
main:- write('Which controller do you want to run: dumb or smart? '),
	read(S), nl,
	write('Executing controller: *'), write(S), writeln('*'), 
	(S = dumb -> main_dumb ;
	S = smart -> main_smart ;
		writeln('Sorry, you have to select one of the two controllers')
	).

main_dumb:- 	indigolog(dumb_control).
main_smart:- 	indigolog(smart_control).
