...
:- ensure_loaded('lib/systemvar').              % Common facts (device_manager/4)
...
:- ensure_loaded('Interpreters/indigolog').

:- ensure_loaded('Interpreters/flux/flux').
...
:- ensure_loaded(flux_wumpus).                          % Application code in Flux
...
:- ensure_loaded('Env/dev_managers').              % Common facts (device_manager/4)
