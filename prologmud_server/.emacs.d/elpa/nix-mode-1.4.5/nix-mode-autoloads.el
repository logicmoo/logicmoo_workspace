...
(register-definition-prefixes "nix-build" '("nix-build"))
...
(register-definition-prefixes "nix-drv-mode" '("nix-drv-mode"))
...
(register-definition-prefixes "nix-edit" '("nix-edit"))
...
(register-definition-prefixes "nix-log" '("nix-log"))
...
(register-definition-prefixes "nix-search" '("nix-search-read-attr"))
...
(register-definition-prefixes "nix-store" '("nix-store-realise"))
