;;; button-lock-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...

;;;### (autoloads nil "button-lock" "button-lock.el" (0 0 0 0))
...
To see an effect in any given buffer, button-lock mode must be
deactivated and reactivated." t nil)
