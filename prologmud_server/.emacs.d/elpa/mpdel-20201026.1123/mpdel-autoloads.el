;;; mpdel-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "mpdel" '("mpdel-"))
...
(register-definition-prefixes "mpdel-browser" '("mpdel-browser-"))
...
(register-definition-prefixes "mpdel-core" '("mpdel-core-"))
...
(register-definition-prefixes "mpdel-playlist" '("mpdel-playlist-"))
...
(register-definition-prefixes "mpdel-song" '("mpdel-song-"))
...
(register-definition-prefixes "mpdel-tablist" '("mpdel-tablist-"))
