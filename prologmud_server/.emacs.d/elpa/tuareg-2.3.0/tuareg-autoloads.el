...
(register-definition-prefixes "tuareg-jbuild" '("tuareg-jbuild-" "verbose-tuareg-jbuild-smie-rules"))
...
(register-definition-prefixes "tuareg-site-file" '("camldebug" "run-ocaml"))
