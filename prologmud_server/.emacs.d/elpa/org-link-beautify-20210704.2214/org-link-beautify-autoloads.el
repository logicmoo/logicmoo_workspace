;;; org-link-beautify-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
`Org-Link-Beautify mode' mode.  If the prefix argument is
...
(register-definition-prefixes "org-link-beautify" '("org-link-beautify-"))
