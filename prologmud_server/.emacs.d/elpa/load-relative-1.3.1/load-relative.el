...
;; 2019-06-01  rocky  <rocky@gnu.org>
;; 
;; 	Some small lint-like things.
;; 
;; 	Sync version numbers in confifure.ac and load-relative.el Try lexical
;; 	binding (when available). Thank Stefan.
;; 
;; 2019-05-31  Stefan Monnier  <monnier@iro.umontreal.ca>
;; 
;; 	* load-relative.el (require-relative-list): Don't spuriously require
;; 	`cl`.
;; 
;; 	Use `eval-and-compile` to simplify the code.
;; 	(autoload-relative): Use `mapc` since we don't care about the return
;; 	value.
;; 
