;;; zencoding-mode-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
`Zencoding mode' mode.  If the prefix argument is positive,
...
(autoload 'zencoding-expand-yas "zencoding-mode" nil t nil)
...
(register-definition-prefixes "zencoding-mode" '("zencoding-"))
