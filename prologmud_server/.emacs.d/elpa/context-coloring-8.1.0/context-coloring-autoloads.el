...

;;;### (autoloads nil "context-coloring" "context-coloring.el" (0
;;;;;;  0 0 0))
...
Color the current Emacs Lisp buffer." t nil)
...
Color the `eval-expression' minibuffer prompt as elisp." t nil)

(autoload 'context-coloring-eval-expression-predicate "context-coloring-emacs-lisp" "\
Non-nil if the minibuffer is for `eval-expression'." nil nil)
...
Color the buffer using the `js2-mode'." nil nil)
...
;;;***

;;;### (autoloads nil nil ("context-coloring-pkg.el") (0 0 0 0))
