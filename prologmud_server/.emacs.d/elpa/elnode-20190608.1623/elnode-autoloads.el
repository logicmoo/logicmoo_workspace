;;; elnode-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
(register-definition-prefixes "elnode" '("ELNODE-FORM-DATA-TYPE" "elnode" "http-referrer" "if-elnode-auth" "with-"))

;;;***

;;;### (autoloads nil "elnode-bm" "elnode-bm.el" (0 0 0 0))
;;; Generated autoloads from elnode-bm.el

(autoload 'elnode-bm-handler "elnode-bm" "\


\(fn HTTPCON)" nil nil)

(register-definition-prefixes "elnode-bm" '("elnode-"))

;;;***

;;;### (autoloads nil "elnode-compat" "elnode-compat.el" (0 0 0 0))
;;; Generated autoloads from elnode-compat.el

(register-definition-prefixes "elnode-compat" '("elnode-"))

;;;***

;;;### (autoloads nil "elnode-js" "elnode-js.el" (0 0 0 0))
...
(register-definition-prefixes "elnode-js" '("elnode-"))
...
;;;***

;;;### (autoloads nil "elnode-tests" "elnode-tests.el" (0 0 0 0))
;;; Generated autoloads from elnode-tests.el

(register-definition-prefixes "elnode-tests" '("elnode-"))
...
(register-definition-prefixes "elnode-testsupport" '("assert-elnode-response" "elnode-" "should-" "with-elnode-mock-"))

;;;***

;;;### (autoloads nil "elnode-tools" "elnode-tools.el" (0 0 0 0))
;;; Generated autoloads from elnode-tools.el

(register-definition-prefixes "elnode-tools" '("elnode-" "process-sentinel-set"))
...
;;;***

;;;### (autoloads nil nil ("Dockerfile-install.el" "elnode-pkg.el")
;;;;;;  (0 0 0 0))
