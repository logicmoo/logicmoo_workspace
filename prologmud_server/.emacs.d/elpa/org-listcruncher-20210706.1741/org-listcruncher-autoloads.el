;;; org-listcruncher-autoloads.el --- automatically extracted autoloads  -*- lexical-binding: t -*-
;;
;;; Code:
...
\(fn LISTNAME &key (PARSEFN org-listcruncher-parse-fn) (ORDER nil) (FORMULA nil))" nil nil)
