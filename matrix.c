...
//#define YAP_ThreadSelf PL_thread_self
/*
...
static YAP_Term YAP_MkBlobTerm(int size)
{
   ...
   PL_blob_t matrix_type;
   char mat[]="matrix";
   matrix_type.magic=PL_BLOB_MAGIC;
   matrix_type.flags=0;
...
static void * YAP_BlobOfTerm(YAP_Term t)
{
  void * blob;
  size_t len;
  PL_blob_t * type;
  PL_get_blob(t,&blob,&len,&type);
  return blob;
}

static YAP_Term YAP_TermNil(void)
{
  return (YAP_Term) 0;
}
...
static YAP_Bool
new_ints_matrix(term_t YAP_ARG1,...)
{
...
static YAP_Bool
new_ints_matrix_set(term_t YAP_ARG1,...)
{
  int ndims = YAP_IntOfTerm(YAP_ARG1);
...
static YAP_Bool
new_floats_matrix(term_t YAP_ARG1,...)
{
  int ndims = YAP_IntOfTerm(YAP_ARG1);
  YAP_Term tl = YAP_ARG2, out;
  int dims[MAX_DIMS];
...
static YAP_Bool
new_floats_matrix_set(term_t YAP_ARG1,...)
{
  int ndims = YAP_IntOfTerm(YAP_ARG1);
  YAP_Term tl = YAP_ARG2, out, tset = YAP_ARG3;
  int dims[MAX_DIMS];
...
static YAP_Term YAP_FloatsToList(double *dblp, size_t sz)
{
  YAP_Term el,l;
  if (sz==0)
    return YAP_TermNil();
  else
  {
    ...
    while (sz)
    { 
      el=YAP_MkFloatTerm(*dblp+sz-1);
      l=YAP_MkPairTerm(el,l);
      sz--;
    }
    return l;
  }
...
static YAP_Term
float_matrix_to_list(int *mat,term_t YAP_ARG1) {
...
static YAP_Term
long_matrix_to_list(int *mat,term_t YAP_ARG1) {
...
static YAP_Bool
matrix_set_all(term_t YAP_ARG1,...)
{
  int *mat;
  YAP_Term tf;
...
static YAP_Bool
do_matrix_access(term_t YAP_ARG1,...)
{
  int dims[MAX_DIMS], *mat;
  YAP_Term tf;
...
static YAP_Bool
do_matrix_access2(term_t YAP_ARG1,...)
{
  int dims[MAX_DIMS], *mat;
  YAP_Term tf, t = YAP_ARG1;
...
static YAP_Bool
do_matrix_inc2(term_t YAP_ARG1,...)
{
  int dims[MAX_DIMS], *mat;
...
static YAP_Bool
do_matrix_dec2(term_t YAP_ARG1,...)
{
  int dims[MAX_DIMS], *mat;
...
static YAP_Bool
matrix_to_list(term_t YAP_ARG1,...)
{
  int *mat;
  YAP_Term tf;
  ...
  if (mat[MAT_TYPE] == INT_MATRIX)
    tf = long_matrix_to_list(mat,YAP_ARG1);
  else
    tf = float_matrix_to_list(mat,YAP_ARG1);
  return YAP_Unify(YAP_ARG2, tf);
}

static YAP_Bool
matrix_set_base(term_t YAP_ARG1,...)
{
  int *mat;
...
static YAP_Bool
matrix_arg_to_offset(term_t YAP_ARG1,...)
{
...
static YAP_Bool
matrix_offset_to_arg(term_t YAP_ARG1,...)
{
  int indx[MAX_DIMS], *mat;
  unsigned int off;
  YAP_Term ti, tf;
...
static YAP_Bool
matrix_log_all(term_t YAP_ARG1,...)
{
  int *mat;
...
static YAP_Bool
matrix_log_all2(term_t YAP_ARG1,...)
{
  int *mat;
...
static YAP_Bool
matrix_exp_all(term_t YAP_ARG1,...)
{
  int *mat;
...
static YAP_Bool
matrix_exp2_all(term_t YAP_ARG1,...)
{
  int *mat;
...
static YAP_Bool
matrix_exp_all2(term_t YAP_ARG1,...)
{
  int *mat;
...
static YAP_Bool
matrix_agg_lines(term_t YAP_ARG1,...)
{
  int *mat;
  YAP_Term tf;
...
static YAP_Bool
matrix_agg_cols(term_t YAP_ARG1,...)
{
  int *mat;
  YAP_Term tf;
  YAP_Term top = YAP_ARG2;
...
static YAP_Bool
matrix_op_to_lines(term_t YAP_ARG1,...)
{
  int *mat1, *mat2;
...
static YAP_Bool
matrix_op_to_cols(term_t YAP_ARG1,...)
{
  int *mat1, *mat2;
  YAP_Term top = YAP_ARG3;
  op_type op;
...
static YAP_Bool
matrix_op_to_all(term_t YAP_ARG1,...)
{
  int *mat;
  YAP_Term tf = 0;
  YAP_Term top = YAP_ARG2;
...
*/ 
static YAP_Bool
matrix_transpose(term_t YAP_ARG1,...)
{
...
*/ 
static YAP_Bool
matrix_sum_out(term_t YAP_ARG1,...)
{
...
*/ 
static YAP_Bool
matrix_sum_out_several(term_t YAP_ARG1,...)
{
...
*/ 
static YAP_Bool
matrix_sum_out_logs(term_t YAP_ARG1,...)
{
...
*/ 
static YAP_Bool
matrix_sum_out_logs_several(term_t YAP_ARG1,...)
{
  int ndims, i, *dims, newdims;
  int indx[MAX_DIMS], nindx[MAX_DIMS], conv[MAX_DIMS];
  YAP_Term tf, tconv;
...
*/ 
static YAP_Bool
matrix_set_all_that_disagree(term_t YAP_ARG1,...)
{
  int ndims, i, *dims;
  int indx[MAX_DIMS];
  YAP_Term tf;
