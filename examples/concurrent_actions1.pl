...
% Only one action should be selected at time 2 for execution.
% The other action is selected for execution later at time 4 after restock takes place.


initial_state( [stock(15)] ).
