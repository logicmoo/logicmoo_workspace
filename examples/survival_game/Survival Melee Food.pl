...
initial_state([
	...
	position(amanda, east, 4, 3),
	holds_wood(amanda, 0),
	holds_food(amanda, 0, 0, 0, 0),
	health(amanda, 50),
	hunger(amanda, 20), 
	has_shelter(amanda, true),
	shelter(amanda, 100, 1, 1),
	turns(amanda, 0),
	

	position(peter, east, 6, 9),
	holds_wood(peter, 0),
	holds_food(peter, 0, 0, 0, 0),
	health(peter, 50),
	hunger(peter, 20),
	has_shelter(peter, true),
	shelter(peter, 100, 1, 8),
	turns(peter, 0),


	position(alex, east, 5, 18),
	holds_wood(alex, 0),
	holds_food(alex, 0, 0, 0, 0),
	health(alex, 50),
	hunger(alex, 20),
	has_shelter(alex, false),
	turns(alex, 0),

	animal(rabbit, 5, north, 10, 3),
	animal(chicken, 10, north, 10, 9),
	animal(cow, 20, north, 10, 18),
