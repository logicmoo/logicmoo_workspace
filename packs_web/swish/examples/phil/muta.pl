...
Used in
Nicola Di Mauro, Elena Bellodi, and Fabrizio Riguzzi. Bandit-based Monte-Carlo structure learning of probabilistic logic programs. 
...
/** <examples>
?- induce_hplp([1,2,3,4,5,6,7,8,9],P),test_hplp(P,[10],LL,AUCROC,ROC,AUCPR,PR).  % learn the structure and test the result
?- induce_hplp_par([1,2,3,4,5,6,7,8,9],P),test_hplp(P,[10],LL,AUCROC,ROC,AUCPR,PR). % learn the parameteters and test the result 
?- induce_hplp([1,2,3,4,5,6,7,8,9],P).  % learn the structure
?- in(P),test_hplp(P,[10],LL,AUCROC,ROC,AUCPR,PR).
*/
...
% Structure learning settings: Sleahp
:- set_hplp(megaex_bottom,4). % max number of mega examples to considered in the generation of bottoms clauses
:- set_hplp(initial_clauses_per_megaex,1).
:- set_hplp(rate,0.95). % defines the probabilityu for going from the first layer to the second
:- set_hplp(max_layer,3). % defines the max number of layer: -1 for the maximum depth possible 
:- set_hplp(min_probability,0.00001). % threshold value of the probability under which a clauses is dropped out

% Parameter learning settings: PHIL
...
:- set_hplp(gamma,10). % set the value of gamma according to the type  (gamma=a if type=3)
:- set_hplp(gammaCount,0). % set the value of gamma Count according to the type (if o gamma is unchanged during the regularization) (gammaCount=b if type=3)

% Adam parameter for dphil algorithm
:- set_hplp(adam_params,[0.001,0.9,0.999,1e-8]).  % adam(Eta,Beta1,Beta2,Epsilon_adam_hat)
% Gradient descent strategy and the corresponding batch size
:- set_hplp(batch_strategy,minibatch(100)). 
%:- set_hplp(batch_strategy,stoch_minibatch(100)).
...
active:0.357487776332185:-bond(B,C,1), hidden_1(B,C).
active:0.340898624195916:-benzene(D), hidden_2(D).
active:0.582734573004553:-benzene(E), hidden_3(E).
active:0.941825686550751:-benzene(F), hidden_4(F).
active:0.228004056442919:-carbon_6_ring(G), hidden_5(G).
active:0.494183046826314:-nitro(H).
hidden_1(B,C):0.736264184849565:-bond(C,I,7), hidden_1_1(B,C,I).
hidden_1(B,C):0.168787562371174:-bond(J,B,7), hidden_1_2(C,J,B).
hidden_1(B,C):0.454410799028266:-bond(C,K,7), hidden_1_3(B,C,K).
hidden_1(B,C):0.446754478916273:-bond(L,B,7), hidden_1_4(C,L,B).
hidden_1(B,C):0.424631963375601 :- atm(B,c,194,M).
hidden_1(B,C):0.652562538902137 :- atm(C,c,194,M), hidden_1_5(B,C,M).
hidden_2(D):0.7502632997666 :- ring_size_6(D).
hidden_3(E):0.23603140768291 :- ring_size_6(E).
hidden_4(F):0.396377413924317 :- ring_size_6(F).
hidden_5(G):0.184361401388437 :- ring_size_6(G).
hidden_1_1(B,C,I):0.500542906002477 :- bond(I,N,1), hidden_1_1_1(B,C,I,N).
hidden_1_2(C,J,B):0.349644341358827 :- bond(J,O,7), hidden_1_2_1(C,B,J,O).
hidden_1_3(B,C,K):0.494469676195735 :- bond(K,P,7), hidden_1_3_1(B,C,K,P).
hidden_1_3(B,C,K):0.85520849094512 :- bond(K,Q,1), hidden_1_3_2(B,C,K,Q).
hidden_1_3(B,C,K):0.548991457402319 :- atm(K,c,22,R), hidden_1_3_3(B,C,K,R).
hidden_1_4(C,L,B):0.288358421277717 :- bond(L,S,1), hidden_1_4_1(C,B,L,S).
hidden_1_4(C,L,B):0.338499280201951 :- atm(L,c,22,R).
hidden_1_5(B,C,M):0.287247194271313 :- atm(I,c,29,M).
hidden_1_1_1(B,C,I,N):0.96605990761734 :- bond(N,T,7), hidden_1_1_1_1(B,C,I,N,T).
hidden_1_1_1(B,C,I,N):0.268883642866368 :- bond(N,U,7), hidden_1_1_1_2(B,C,I,N,U).
hidden_1_2_1(C,B,J,O):0.550948227638125 :- bond(O,V,7), hidden_1_2_1_1(C,B,J,O,V).
hidden_1_2_1(C,B,J,O):0.080582214186416 :- bond(O,W,1).
hidden_1_3_1(B,C,K,P):0.382835498937712 :- bond(P,X,7), hidden_1_3_1_1(B,C,K,P,X).
hidden_1_3_1(B,C,K,P):0.993650592148131 :- bond(P,Y,1).
hidden_1_3_2(B,C,K,Q):0.26973723073878 :- atm(Q,h,3,Z), hidden_1_3_2_1(B,C,K,Q,Z).
hidden_1_3_3(B,C,K,R):0.457890035281585 :- atm(P,c,22,R).
hidden_1_4_1(C,B,L,S):0.305704410269012 :- atm(S,h,3,Z).
hidden_1_1_1_1(B,C,I,N,T):0.81033625055707 :- bond(T,J,1).
hidden_1_1_1_2(B,C,I,N,U):0.166583284840457 :- bond(U,A1,7), hidden_1_1_1_2_1(B,C,I,N,U,A1).
hidden_1_1_1_2(B,C,I,N,U):0.16308490069504 :- bond(U,B1,1), hidden_1_1_1_2_2(B,C,I,N,U,B1).
hidden_1_1_1_2(B,C,I,N,U):0.12477486268781 :- atm(U,c,22,R), hidden_1_1_1_2_3(B,C,I,N,U,R).
hidden_1_2_1_1(C,B,J,O,V):0.382971044879496 :- bond(V,C1,7), hidden_1_2_1_1_1(C,B,J,O,V,C1).
hidden_1_2_1_1(C,B,J,O,V):0.573270498746699 :- bond(V,D1,1).
hidden_1_3_1_1(B,C,K,P,X):0.38576406030942 :- bond(X,E1,7), hidden_1_3_1_1_1(B,C,K,P,X,E1).
hidden_1_3_1_1(B,C,K,P,X):0.163798109233059 :- bond(X,F1,1).
hidden_1_3_2_1(B,C,K,Q,Z):0.646181883923972 :- atm(Y,h,3,Z).
hidden_1_1_1_2_1(B,C,I,N,U,A1):0.928736601752103 :- bond(A1,G1,7), hidden_1_1_1_2_1_1(B,C,I,N,U,A1,G1).
hidden_1_1_1_2_1(B,C,I,N,U,A1):0.430455614581996 :- bond(A1,H1,1).
hidden_1_1_1_2_2(B,C,I,N,U,B1):0.436883752803264 :- atm(B1,h,3,Z), hidden_1_1_1_2_2_1(B,C,I,N,U,B1,Z).
hidden_1_1_1_2_3(B,C,I,N,U,R):0.500564898398079 :- atm(A1,c,22,R).
hidden_1_2_1_1_1(C,B,J,O,V,C1):0.781724261054953 :- bond(C1,L,7).
hidden_1_3_1_1_1(B,C,K,P,X,E1):0.495282954688513 :- bond(E1,I,7).
hidden_1_1_1_2_1_1(B,C,I,N,U,A1,G1):0.505780545318464 :- bond(G1,I1,7), hidden_1_1_1_2_1_1_1(B,C,I,N,U,A1,G1,I1).
hidden_1_1_1_2_1_1(B,C,I,N,U,A1,G1):0.598684319132542 :- bond(G1,J1,1), hidden_1_1_1_2_1_1_2(B,C,I,N,U,A1,G1,J1).
hidden_1_1_1_2_2_1(B,C,I,N,U,B1,Z):0.569279871917298 :- atm(H1,h,3,Z).
hidden_1_1_1_2_1_1_1(B,C,I,N,U,A1,G1,I1):0.491281948987711 :- bond(I1,T,7).
hidden_1_1_1_2_1_1_2(B,C,I,N,U,A1,G1,J1):0.762356467970208 :- bond(J1,K1,2), hidden_1_1_1_2_1_1_2_1(B,C,I,N,U,A1,G1,J1,K1).
hidden_1_1_1_2_1_1_2(B,C,I,N,U,A1,G1,J1):0.029862922211226 :- bond(J1,L1,2), hidden_1_1_1_2_1_1_2_2(B,C,I,N,U,A1,G1,J1,L1).
hidden_1_1_1_2_1_1_2(B,C,I,N,U,A1,G1,J1):0.195239813730009 :- atm(J1,n,38,M1).
hidden_1_1_1_2_1_1_2_1(B,C,I,N,U,A1,G1,J1,K1):0.156138181567595 :- atm(K1,o,40,N1).
hidden_1_1_1_2_1_1_2_2(B,C,I,N,U,A1,G1,J1,L1):0.377647837402305 :- atm(L1,o,40,O1).
