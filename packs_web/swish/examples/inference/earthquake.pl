...
% earthquake at eyjafjallajokull?
% expected result 0.6
?- prob(earthquake(stromboli,strong),Prob),bar(Prob,C).  % what is the probability of a strong 
% earthquake at stromboli?
% expected result 0.43999999999999995
?- prob(earthquake(stromboli,moderate),Prob),bar(Prob,C).  % what is the probability of a moderate
% earthquake at stromboli?
% expected result 0.7999999999999998
?- prob(earthquake(eyjafjallajokull,strong),Prob),bar(Prob,C).  % what is the probability of a strong 
% earthquake at eyjafjallajokull?
% expected result 0.2
?- prob(earthquake(eyjafjallajokull,moderate),Prob),bar(Prob,C). % what is the probability of a moderate
% earthquake at eyjafjallajokull?
% expected result 0.6
