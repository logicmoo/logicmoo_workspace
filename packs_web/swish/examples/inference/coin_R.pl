...
?- prob(heads(coin),Prob),bar_r(Prob).  % what is the probability that coin lands heads?
% expected result 0.51
?- prob(tails(coin),Prob),bar_r(Prob).  % what is the probability that coin lands tails?
% expected result 0.49
