...
file(INSTALL DESTINATION "/opt/logicmoo_workspace/packs_web/swish/pack/libssh/lib/x86_64-linux" TYPE MODULE FILES "/opt/logicmoo_workspace/packs_web/swish/pack/libssh/build/sshd4pl.so")
  if(EXISTS "$ENV{DESTDIR}/opt/logicmoo_workspace/packs_web/swish/pack/libssh/lib/x86_64-linux/sshd4pl.so" AND
     NOT IS_SYMLINK "$ENV{DESTDIR}/opt/logicmoo_workspace/packs_web/swish/pack/libssh/lib/x86_64-linux/sshd4pl.so")
    file(RPATH_CHANGE
         FILE "$ENV{DESTDIR}/opt/logicmoo_workspace/packs_web/swish/pack/libssh/lib/x86_64-linux/sshd4pl.so"
    ...
    if(CMAKE_INSTALL_DO_STRIP)
      execute_process(COMMAND "/usr/bin/strip" "$ENV{DESTDIR}/opt/logicmoo_workspace/packs_web/swish/pack/libssh/lib/x86_64-linux/sshd4pl.so")
    endif()
  endif()
endif()
...
file(WRITE "/opt/logicmoo_workspace/packs_web/swish/pack/libssh/build/${CMAKE_INSTALL_MANIFEST}"
     "${CMAKE_INSTALL_MANIFEST_CONTENT}")
