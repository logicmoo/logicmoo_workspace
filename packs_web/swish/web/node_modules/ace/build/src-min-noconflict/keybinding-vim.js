ace.define("ace/keyboard/vim", ["require", "exports", "module", "ace/range", "ace/lib/event_emitter", "ace/lib/dom", "ace/lib/oop", "ace/lib/keys", "ace/lib/event", "ace/search", "ace/lib/useragent", "ace/search_highlight", "ace/commands/multi_select_commands", "ace/mode/text", "ace/multi_select"], function(e, t, n) {
  ...
  function T(e) {
    e.setOption("disableInput", !0), e.setOption("showCursorWhenSelecting", !1), v.signal(e, "vim-mode-change", {
      mode: "normal"
    }), e.on("cursorActivity", er), rt(e), v.on(e.getInputField(), "paste", _(e))
  }
  ...
  function G(e, t, n, r, i) {
    ...
    if (r)
      for (var s = 0; s < r.length; s++) Q[r[s]] = Q[e];
    t && Y(e, t)
  }
  ...
  function Vt(e, t, n, r) {
    ...
    if (n == "char") {
      ...
      return i = Tt(t.head, 0, o), s = Tt(t.anchor, 0, u), {
        ranges: [{
          anchor: s,
          head: i
        }],
  ...
  function Jt(e, t) {
    var n = e.state.vim;
    t !== !1 && e.setCursor(St(e, n.sel.head)), zt(e, n), n.visualMode = !1, n.visualLine = !1, n.visualBlock = !1, v.signal(e, "vim-mode-change", {
      mode: "normal"
  ...
  function hn(e, t, n, r) {
    ...
    function s(e, t, n, r) {
      ...
      while (u.line !== null) {
        ...
        if (o && u.line !== "" && !$(u.line[u.pos])) return {
          ln: u.ln,
          pos: u.pos
        };
  ...
  function Zn(e, t) {
    ...
    if (!n.isPlaying)
      while (t) {
        ...
        else if (t.origin == "+input" || t.origin == "paste" || t.origin === undefined) {
  ...
  function nr(e, t, n) {
    var r = e.getCursor("anchor"),
      i = e.getCursor("head");
    t.visualMode && !e.somethingSelected() ? Jt(e, !1) : !t.visualMode && !t.insertMode && e.somethingSelected() && (t.visualMode = !0, t.visualLine = !1, v.signal(e, "vim-mode-change", {
      mode: "visual"
    }));
    if (t.visualMode) {
      var s = Mt(i, r) ? 0 : -1,
  ...
  function cr(e, t, n) {
    ...
    if (t == "<Esc>" && !i.insertMode && !i.visualMode && o) e.ace.exitMultiSelectMode();
  ...
  v.Pos = function(e, t) {
    ...
    }, v.keyMap = {}, v.addClass = v.rmClass = function() {}, v.e_stop = v.e_preventDefault = f.stopEvent, v.keyName = function(e) {
    ...
    function() {
      ...
      this.setOption = function(e, n) {
        ...
        if (t == 1) var o = this.ace.session.$findClosingBracket(i.slice(1, 2), m(e), s);
        else var o = this.ace.session.$findOpeningBracket(i.slice(-2, -1), {
          row: e.line,
          column: e.ch + 1
        }, s);
        return o && {
  ...
  var dt = {
        ...
        if (s) {
          ...
          if (t.visualMode) {
            ...
            if (N) {
              var L = k.ranges;
              if (C == "block")
                for (var A = 0; A < L.length; A++) L[A].head.ch = Ht(e, L[A].head.line);
    ...
    vt = {
      ...
      moveToMatchedSymbol: function(e, t) {
        ...
        if (i < s.length) {
          var a = /[<>]/.test(s[i]) ? /[(){}[\]<>]/ : /[(){}[\]]/,
            f = e.findMatchingBracket(S(r, i + 1), {
              bracketRegex: a
            });
          return f.to
        }
    ...
    yt = {
      change: function(e, t, n) {
        ...
        else if (t.fullLine) u.ch = Number.MAX_VALUE, u.line--, e.setSelection(o, u), i = e.getSelection(), e.replaceSelection(""), r = o;
        else {
          i = e.getSelection();
          var h = gt("", n.length);
          e.replaceSelections(h), r = _t(n[0].head, n[0].anchor)
        }
        it.registerController.pushText(t.registerName, "change", i, t.linewise, n.length > 1), wt.enterInsertMode(e, {
          head: r
        }, e.state.vim)
      },
    ...
    wt = {
      ...
      toggleOverwrite: function(e) {
        e.state.overwrite ? (e.toggleOverwrite(!1), e.setOption("keyMap", "vim-insert"), v.signal(e, "vim-mode-change", {
          mode: "insert"
        })) : (e.toggleOverwrite(!0), e.setOption("keyMap", "vim-replace"), v.signal(e, "vim-mode-change", {
          mode: "replace"
        }))
      },
      enterInsertMode: function(e, t, n) {
        ...
        else if (r == "firstNonBlank") s = vt.moveToFirstNonWhiteSpaceCharacter(e, s);
        ...
        e.setOption("disableInput", !1), t && t.replace ? (e.toggleOverwrite(!0), e.setOption("keyMap", "vim-replace"), v.signal(e, "vim-mode-change", {
          mode: "replace"
        })) : (e.toggleOverwrite(!1), e.setOption("keyMap", "vim-insert"), v.signal(e, "vim-mode-change", {
          mode: "insert"
        })), it.macroModeState.isPlaying || (e.on("change", Zn), v.on(e.getInputField(), "keydown", ir)), n.visualMode && Jt(e), qt(e, s, o)
      },
  ...
  var zn = {
      ...
      sort: function(e, t) {
        ...
        g.sort(o ? x : E);
        if (o)
          for (var b = 0; b < g.length; b++) g[b] = g[b].input;
        else s || y.sort(E);
