ace.define("ace/mode/autohotkey_highlight_rules", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text_highlight_rules"], function(e, t, n) {
    ...
    s = function() {
      ...
      this.$rules = {
        start: [{
          ...
          token: ["punctuation.quote.double", "string.quoted.ahk", "punctuation.quote.double"],
          regex: '(")((?:[^"]|"")*)(")'
        }, {
  ...
  }, r.inherits(s, i), t.AutoHotKeyHighlightRules = s
...
}), ace.define("ace/mode/autohotkey", ["require", "exports", "module", "ace/lib/oop", "ace/mode/text", "ace/mode/autohotkey_highlight_rules", "ace/mode/folding/cstyle"], function(e, t, n) {
  "use strict";
  var r = e("../lib/oop"),
    i = e("./text").Mode,
    s = e("./autohotkey_highlight_rules").AutoHotKeyHighlightRules,
