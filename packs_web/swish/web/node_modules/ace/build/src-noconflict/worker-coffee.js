    ...
    var CoffeeScript = function() {
      ...
      return require["../../package.json"] = function() {
            ...
            return function(l) {
              ...
              if (null != (null == l ? void 0 : l.updateLocationDataIfMissing) && null != n && l.updateLocationDataIfMissing(t(n, r)), !e.tokenComments)
                for (e.tokenComments = {}, c = e.parser.tokens, s = 0, i = c.length; s < i; s++)
                  if (p = c[s], !!p.comments)
                    if (u = o(p[2]), null == e.tokenComments[u]) e.tokenComments[u] = p.comments;
                    else {
                      var m;
        ...
        return function() {
          var a = [].indexOf,
            t = require("./helpers"),
            o, n, r, l, s, d, c, p, u, m, h, i, g, f, y, T, N, v, k, b, $, _, C;
                  ...
                  value: function addImplicitBracesAndParens() {
                    ...
                    return e = [], t = null, this.scanTokens(function(o, l, f) {
                      var i = this,
                        ...
                        T, v, b, $, _, C, D, E, x, I, S, A, R, k, O, L, F, w, P, j, M, U, V, s, B, G, H, W, X, Y, q, z, J;
                      J = y[0];
                      var K = P = 0 < l ? f[l - 1] : [],
                      ...
                      if (0 <= a.call(g, J))
                        for (R = e.length - 1; 0 <= R && (G = e[R], !!I(G)); R += -1) A(G) && (G[2].sameLine = !1);
                      if (k = "OUTDENT" === w || P.newLine, 0 <= a.call(u, J) || 0 <= a.call(n, J) && k || (".." === J || "..." === J) && this.findTagsBackwards(l, ["INDEX_START"]))
                        for (; C();) {
                          ...
                          H = ne[0], B = ne[1];
                          var re = ne[2];
                          if (s = re.sameLine, z = re.startsLine, D() && "," !== w || "," === w && "TERMINATOR" === J && null == O) T();
                          else if (x() && s && "TERMINATOR" !== J && ":" !== w && !(("POST_IF" === J || "FOR" === J || "WHILE" === J || "UNTIL" === J) && z && $(l + 1))) v();
                          else if (x() && "TERMINATOR" === J && "," !== w && !(z && this.looksObjectish(l + 1))) v();
                          else break
                        }
                      if ("," === J && !this.looksObjectish(l + 1) && x() && "FOROF" !== (U = this.tag(l + 2)) && "FORIN" !== U && ("TERMINATOR" !== O || !this.looksObjectish(l + 2)))
                        for (F = "OUTDENT" === O ? 1 : 0; x();) v(l + F);
                      return b(1)
                    })
                  }
                }, {
        ...
        return function() {
          var a = [].indexOf,
            t = [].slice,
            o = require("./rewriter"),
            n, r, l, s, i, d, c, p, u, m, h, g, f, y, k, T, N, v, b, $, _, C, D, E, x, I, S, A, R, O, L, F, w, P, j, M, U, V, B, G, H, W, X, Y, q, z, J, K, Z, Q, ee, ae, te, oe, ne, re, le, se, ie, de, ce, pe, ue, me, he, ge, fe, ye, ke, Te, Ne, ve, be, $e;
            ...
            return _createClass(e, [{
              ...
              value: function stringToken() {
                var e = this,
                  ...
                  o, n, r, l, s, d, c, i, p, u, m, h, g, f, y, k;
                if (h = t[0], !h) return 0;
              ...
              value: function regexToken() {
                var e = this,
                  t, o, n, r, s, i, d, c, p, u, m, h, g, f, y, k;
                switch (!1) {
                  ...
                  case !(u = this.matchWithInterpolations($, "///")):
                    ...
                    if (k = T.tokens, d = T.index, r = this.chunk.slice(0, d).match(/\s+(#(?!{).*)/g), r)
                      for (c = 0, p = r.length; c < p; c++) n = r[c], this.commentToken(n);
                    break;
              ...
              value: function literalToken() {
                ...
                else if ("*" === y && "EXPORT" === (null == n ? void 0 : n[0])) g = "EXPORT_ALL";
                else if (0 <= a.call(P, y)) g = "MATH";
                else if (0 <= a.call(m, y)) g = "COMPARE";
                else if (0 <= a.call(h, y)) g = "COMPOUND_ASSIGN";
                else if (0 <= a.call(le, y)) g = "UNARY";
                else if (0 <= a.call(se, y)) g = "UNARY_MATH";
                else if (0 <= a.call(J, y)) g = "SHIFT";
                else if ("?" === y && (null == n ? void 0 : n.spaced)) g = "BIN?";
                else if (n)
                  if ("(" === y && !n.spaced && (c = n[0], 0 <= a.call(l, c))) "?" === n[0] && (n[0] = "FUNC_EXIST"), g = "CALL_START";
                  else if ("[" === y && ((p = n[0], 0 <= a.call(x, p)) && !n.spaced || "::" === n[0])) switch (g = "INDEX_START", n[0]) {
                  case "?":
                    n[0] = "INDEX_SOAK"
                }
              ...
              value: function suppressSemicolons() {
                var e, t, o;
                for (o = [];
                  ";" === this.value();) this.tokens.pop(), (e = null == (t = this.prev()) ? void 0 : t[0], 0 <= a.call(["="].concat(_toConsumableArray(ie)), e)) ? o.push(this.error("unexpected ;")) : o.push(void 0);
                return o
              }
            }, {
              key: "error",
        ...
        return function() {
          var a = [].indexOf,
            t = [].splice,
            n = [].slice,
            r, s, d, o, l, c, i, p, u, m, h, g, f, y, k, T, N, v, b, $, _, C, D, E, x, I, S, A, R, O, L, F, w, P, j, M, U, V, B, G, H, W, X, Y, q, z, J, K, Z, Q, ee, ae, te, oe, ne, re, le, se, ie, de, ce, pe, ue, me, he, ge, fe, ye, ke, Te, Ne, ve, be, $e, _e, Ce, De, Ee, xe, Ie, Se, Ae, Re, Oe, Le, Fe, we, Pe, je, Me, Ue, Ve, Be, Ge, He, We, Xe, Ye, qe, ze, Je, Ke, Ze, Qe, ea, aa, ta, oa, na, ra, la, sa;
              ...
              return _inherits(t, e), _createClass(t, [{
                ...
                value: function compileNode(e) {
                  ...
                  for (this.tab = e.indent, u = e.level === z, o = [], p = this.expressions, l = s = 0, d = p.length; s < d; l = ++s) {
                    ...
                    if (c = c.unfoldSoak(e) || c, c instanceof t) o.push(c.compileNode(e));
                    else if (u) {
                    ...
                    if (n = e[i], n.precedingComments) {
                      ...
                      for (t = "\n" + s + function() {
                        ...
                        if (y = v[k], g = y.code.lastIndexOf("\n"), -1 === g)
                          if (0 === k) y.code = "\n" + y.code, g = 0;
                          else if (y.isStringWithInterpolations && "{" === y.code) t = t.slice(1) + "\n", g = 1;
                        else continue;
                    ...
                    if (n.followingComments) {
                      ...
                      for (t = 1 === i && /^\s+$/.test(e[0].code) ? "" : _ ? " " : "\n" + s, t += function() {
                        ...
                        if (C = $[D], g = C.code.indexOf("\n"), -1 === g)
                          ...
                          else if (C.isStringWithInterpolations && "}" === C.code) t += "\n", g = 0;
                        else continue;
                ...
                value: function compileNode(e) {
                  ...
                  if (t = [], this.expression) {
                    for (t = this.expression.compileToFragments(e, q), la(t, this.makeCode(this.tab + "return ")), n = 0, r = t.length; n < r; n++)
                      ...
                      else if (o.isLineComment) o.code = "" + this.tab + o.code;
                    else break
                  }
            ...
            var e = function(e) {
              ...
              return _inherits(a, e), _createClass(a, [{
                ...
                value: function unfoldSoak(e) {
                  var t, o, n, r, l, s, i, d;
                  if (this.soak) {
                    if (this.variable instanceof $e) r = new K(this.variable.compile(e)), d = new Le(r), null == this.variable.accessor && this.variable.error("Unsupported reference to 'super'");
                    else {
              ...
              return _inherits(a, e), _createClass(a, [{
                ...
                value: function compileNode(e) {
                  ...
                  if (b = this.properties, this.generated)
                    for (c = 0, g = b.length; c < g; c++) N = b[c], N instanceof Le && N.error("cannot have an implicit value in an implicit object");
                  ...
                  for (t = [], t.push(this.makeCode(i ? "" : "\n")), o = $ = 0, T = b.length; $ < T; o = ++$) {
                    ...
                    else if (!(m instanceof Le && m.base instanceof f)) "function" == typeof v.bareLiteral && v.bareLiteral(R) || (v = new d(v, v, "object"));
            ...
            var e = function(e) {
              ...
              return _inherits(n, e), _createClass(n, [{
                ...
                value: function compileDestructuring(e) {
                  var t = this,
                    o, l, d, c, p, m, h, g, f, k, T, v, i, b, $, _, C, D, E, x, I, S, A, O, L, F, w, P, j, M, U, B, G, H;
                ...
                return _createClass(e, [{
                  ...
                  value: function generate() {
                    var e = 0 < arguments.length && void 0 !== arguments[0] ? arguments[0] : {},
                      ...
                      t, o, n, r, l, s, i, d, c, p, u, m, h, g, f, y, k;
        ...
        return function() {
          ...
          h = k.parser, p = require("./helpers"), r = require("./sourcemap"), m = require("../../package.json"), e.VERSION = m.version, e.FILE_EXTENSIONS = o = [".coffee", ".litcoffee", ".coffee.md"], e.helpers = p, l = function(e) {
            ...
            var a = 1 < arguments.length && void 0 !== arguments[1] ? arguments[1] : {},
              t, o, n, d, c, m, y, k, T, i, N, v, b, $, _, C, D, E, x, I, S, A, R, O, L;
        ...
        return function() {
          ...
          CoffeeScript = require("./coffeescript"), compile = CoffeeScript.compile, CoffeeScript.eval = function(code) {
            ...
            for (d = window.document.getElementsByTagName("script"), a = ["text/coffeescript", "text/literate-coffeescript"], e = function() {
              ...
              }, o = r = 0, l = e.length; r < l; o = ++r) s = e[o],
              function(o, n) {
                var r, l;
                return r = {
                  literate: o.type === a[1]
