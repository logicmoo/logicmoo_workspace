...
exports.Options = {
    align_assignments: {
        default: false,
        description: "If lists of assignments or properties should be vertically aligned for faster " +
            "and easier reading.",
        since: "0.7.0",
        type: "boolean",
    },
    ...
    end_with_comma: {
        default: false,
        description: "If a terminating comma should be inserted into arrays, object literals, and de" +
            "structured objects.",
        since: "0.7.0",
        type: "boolean",
    },
    ...
    force_indentation: {
        default: false,
        description: "if indentation should be forcefully applied to markup even if it disruptively " +
    ...
    no_leading_zero: {
        default: false,
        description: "If in CSS values leading 0s immediately preceeding a decimal should be removed" +
            " or prevented.",
        since: "0.7.0",
        type: "boolean",
    },
    object_curly_spacing: {
        default: true,
        description: "Inserts a space before/after brackets for object literals, destructuring assig" +
    ...
    quotes: {
        default: "none",
        description: "Convert the quote characters delimiting strings from either double or single q" +
            "uotes to the other.",
