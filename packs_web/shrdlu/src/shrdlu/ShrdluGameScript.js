...
var ShrdluGameScript = /** @class */ (function () {
    ...
    ShrdluGameScript.prototype.update_act_intro = function () {
        var previous_state, term, term, lastPerformative, answer, lastPerformative, answer, lastPerformative, answer, chair_1, chair, term, term, _i, _a, item, term;
        return __generator(this, function (_b) {
            previous_state = this.act_intro_state;
            ...
            switch (this.act_intro_state) {
                ...
                case 4:
                    if (this.act_intro_state_timer == 0) {
                        ...
                        term = Term.fromString("verb.wake-up('player'[#id])", this.game.ontology);
                        this.game.qwertyAI.addLongTermTerm(term, PERCEPTION_PROVENANCE);
                        this.game.etaoinAI.addLongTermTerm(term, PERCEPTION_PROVENANCE);
                    }
                ...
                case 5: // QWERTY goes to do an analysis in the computer, reports player is healthy, and goes back to the infirmary bed:
                    if (this.act_intro_state_timer == 0) {
                        ...
                        term = Term.fromString("healthy('player'[#id])", this.game.ontology);
                        this.game.qwertyAI.addLongTermTerm(term, PERCEPTION_PROVENANCE);
                        // go back to player:
                        this.game.qwertyAI.clearCurrentAction();
                ...
                case 6: // QWERTY asks the player if he remembers his name
                    if (this.act_intro_state_timer == 0) {
                        ...
                        if (this.game.qwertyAI.isIdle()) {
                            lastPerformative = this.contextQwerty.lastPerformativeBy(this.playerID);
                            if (lastPerformative != null && lastPerformative.performative != null &&
                                ...
                                answer = lastPerformative.performative.attributes[1];
                ...
                case 98:
                    if (this.act_intro_state_timer == 0) {
                        ...
                        chair_1 = this.game.findObjectByIDJustObject("512");
                ...
                case 99:
                    ...
                    break;
                case 100:
                    chair = this.game.findObjectByIDJustObject("512");
                ...
                case 101:
                    if (this.act_intro_state_timer == 0) {
                        ...
                        term = Term.fromString("goal(D:'player'[#id],verb.follow(X, 'qwerty'[#id]))", this.game.ontology);
                ...
                case 108:
                    if (this.act_intro_state_timer == 0) {
                        ...
                        term = Term.fromString("goal(D:'player'[#id],action.take(X, 'communicator'[#id]))", this.game.ontology);
                        this.game.qwertyAI.addLongTermTerm(term, MEMORIZE_PROVENANCE);
                    }
                    else if (!this.game.qwertyAI.robot.isTalking()) {
                    ...
                    break;
                case 109:
                    for (_i = 0, _a = this.game.currentPlayer.inventory; _i < _a.length; _i++) {
                        item = _a[_i];
                ...
                case 110:
                    if (this.act_intro_state_timer == 0) {
                        ...
                        term = Term.fromString("goal(D:'player'[#id],verb.go-to(X, 'verb.sleep'[verb.sleep]))", this.game.ontology);
                        this.game.qwertyAI.addLongTermTerm(term, MEMORIZE_PROVENANCE);
                    }
                    else if (!this.game.qwertyAI.robot.isTalking()) {
