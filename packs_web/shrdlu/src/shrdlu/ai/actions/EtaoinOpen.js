...
var EtaoinOpen_IntentionAction = /** @class */ (function (_super) {
    __extends(EtaoinOpen_IntentionAction, _super);
    function EtaoinOpen_IntentionAction() {
        return _super !== null && _super.apply(this, arguments) || this;
    }
    EtaoinOpen_IntentionAction.prototype.canHandle = function (intention, ai) {
        if (intention.functor.is_a(ai.o.getSort("action.open")))
            return true;
        return false;
    };
    EtaoinOpen_IntentionAction.prototype.execute = function (ir, ai_raw) {
        this.ir = ir;
        var ai = ai_raw;
    ...
    EtaoinOpen_IntentionAction.prototype.saveToXML = function (ai) {
        return "<IntentionAction type=\"EtaoinOpen_IntentionAction\"/>";
    };
    EtaoinOpen_IntentionAction.loadFromXML = function (xml, ai) {
        return new EtaoinOpen_IntentionAction();
    };
    return EtaoinOpen_IntentionAction;
}(IntentionAction));
