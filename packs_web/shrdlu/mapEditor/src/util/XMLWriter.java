...
public class XMLWriter {
    ...
    public void closedTagWithAttributes(String tagname, String attributesString) {
        indent();
        try {
            writer.write("<" + tagname + " " + attributesString + "/>\n");
        } catch (IOException e) {
    ...
    public void tagWithAttributes(String tagname, String attributesString, String value) {
        indent();
        try {
            writer.write("<" + tagname + " " + attributesString + ">" + value + "</" + tagname + ">\n");
        } catch (IOException e) {
            e.printStackTrace();
        }
    }
    ...
    public void rawXMLRespectingTabs(String xml) {
        try {
